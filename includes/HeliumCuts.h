...
// enum ECuts, CCNuPionIncConsts, ContainerEraser
#include "CryoTankUtils.h"

//==============================================================================
// USE THESE CUTS by applying a  vector of different cuts to  PassesCutsRECO or
// PassesCutsTRUTH
//==============================================================================
...
const double Maximum_MuonAngle_reduced = 6.0;
const double Minimum_MuonAngle_reduced = 3.0;
...
const double CryoTankExtraAddRegionOutside =
    450.0;  // mm Cut Cut Value for Smearing
            // was 200mm
...
const double Maximum_secTrkwrtb_GreatestKE =
    55;  // For Truth Section of index of second track with Greatest KE
...
bool PassesCutsRECO(const HeliumCVUniverse&, bool is_mc,
                    std::vector<ECuts> cuts);
////////////////////////////////////////////////////////////////////////////////
bool PassesCutsRECO(const HeliumCVUniverse& univ, bool is_mc,
                    std::vector<ECuts> cuts, std::vector<Weights> kWeights,
                    RECO_Cut_Map& CountMap);
////////////////////////////////////////////////////////////////////////////////
bool PassesCutsRECO(const HeliumCVUniverse& univ, bool is_mc,
                    std::vector<ECuts> cuts, std::vector<Weights> kWeights,
                    RECO_Cut_Map& CountMap, double r, double z);
////////////////////////////////////////////////////////////////////////////////
bool PassesCutsRECO(const HeliumCVUniverse& univ, bool is_mc,
                    std::vector<ECuts> cuts, std::vector<Weights> kWeights,
                    RECO_Cut_Map& CountMap, RECO_Cut_Map& CountMap_TrueHelium,
                    RECO_Cut_Map& CountMap_nothelium);
////////////////////////////////////////////////////////////////////////////////
bool PassesCutsRECO(const HeliumCVUniverse& univ, bool is_mc,
                    std::vector<ECuts> cuts, std::vector<Weights> kWeights,
                    RECO_Cut_Map& CountMap, RECO_Cut_Map& CountMap_TrueHelium,
                    RECO_Cut_Map& CountMap_nonHelium, double r, double z);
////////////////////////////////////////////////////////////////////////////////
bool PassesCutsRECOData(const HeliumCVUniverse& univ, bool is_mc,
                        std::vector<ECuts> cuts, RECO_Cut_Map& CountMap);
bool PassesCut(const HeliumCVUniverse&, ECuts cut, bool is_mc);
////////////////////////////////////////////////////////////////////////////////
bool PassesCut(const HeliumCVUniverse& univ, ECuts cut, bool is_mc, double r,
               double z);
////////////////////////////////////////////////////////////////////////////////
bool PassesCutsTRUTH(const HeliumCVUniverse&,
                     std::vector<ECutsTRUTH> TRUTHcuts);
////////////////////////////////////////////////////////////////////////////////
bool PassesCutsTRUTH(const HeliumCVUniverse& univ,
                     std::vector<ECutsTRUTH> TRUTHcuts,
                     std::vector<Weights> kWeights, TRUE_Cut_Map& CountMap);
...
bool TRUTH_IsINFiduicalVolume(const HeliumCVUniverse& univ,
                              double Cut_MiniumDisToCryoTankInnerTank);
////////////////////////////////////////////////////////////////////////////////
bool TRUTH_IsINFiduicalVolume_new(const HeliumCVUniverse&);
////////////////////////////////////////////////////////////////////////////////
bool TRUTH_IsINFiduicalVolume_new(const HeliumCVUniverse&,
                                  double Cut_MiniumDisToCryoTankInnerTank);
////////////////////////////////////////////////////////////////////////////////
...
bool TRUTH_EnergyFraction_AreTrueDigits(
    std::vector<double> E_Fraction, int index,
    double Cut_fraction = HeliumCUTConsts::Truth_EFractionAreTrueDigits);
////////////////////////////////////////////////////////////////////////////////
// RECO cuts eventwide
////////////////////////////////////////////////////////////////////////////////
...
bool IsInExtraFiduicalVolume(const HeliumCVUniverse& univ,
                             double Cut_MiniumDisToCryoTankInnerTank);
////////////////////////////////////////////////////////////////////////////////
bool IsInExtraFiduicalVolume_Non_seperated_Cryo_regions(
    const HeliumCVUniverse& univ, double Cut_MiniumDisToCryoTankInnerTank);
  ////////////////////////////////////////////////////////////////////////////////
bool IsInExtraFiduicalVolume_Non_seperated_Cryo_regions_TRUTH(
    const HeliumCVUniverse& univ, double Cut_MiniumDisToCryoTankInnerTank);
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
bool IssecTrklessthanDeg(
    const HeliumCVUniverse& univ,
    double Max_deg = HeliumCUTConsts::Maximum_secTrkwrtb_CUT);
////////////////////////////////////////////////////////////////////////////////
bool IsVertexChiSqrtLessthanMax(
    const HeliumCVUniverse& univ,
    double Max_chisqrt = HeliumCUTConsts::Maximum_VertexChiSqrt);
////////////////////////////////////////////////////////////////////////////////
bool IsVertexChiSqrtLessthanMax_ByTrackType(
    const HeliumCVUniverse& univ,
    double Max_chisqrt_long = HeliumCUTConsts::Maximum_Longtrack_VertexChiSqrt,
    double Max_chisqrt_otherlong =
        HeliumCUTConsts::Maximum_OtherLongtrack_VertexChiSqrt,
    double Max_chisqrt_short = HeliumCUTConsts::Maximum_Short_VertexChiSqrt);
////////////////////////////////////////////////////////////////////////////////
bool IsVertexConverge_usingALLTracks(const HeliumCVUniverse& univ);
////////////////////////////////////////////////////////////////////////////////
bool TRUTH_IsAtLeastOne_2ndTrk_non_NeutralParticle(
    const HeliumCVUniverse& univ);
////////////////////////////////////////////////////////////////////////////////
bool TRUTH_Is2ndTrk_maxiumAngle_threshold(
    const HeliumCVUniverse& univ,
    double Max_deg = HeliumCUTConsts::Maximum_secTrkwrtb_GreatestKE);
////////////////////////////////////////////////////////////////////////////////
bool TRUTH_Is2ndTrk_maxiumAngle_threshold_No_Neutral(
    const HeliumCVUniverse& univ,
    double Max_deg = HeliumCUTConsts::Maximum_secTrkwrtb_GreatestKE);
////////////////////////////////////////////////////////////////////////////////
bool TRUTH_Is2ndTrk_maxiumAngle_threshold_No_Neutral_leading2ndTrk(
    const HeliumCVUniverse& univ,
    double Max_deg = HeliumCUTConsts::Maximum_secTrkwrtb_GreatestKE);
////////////////////////////////////////////////////////////////////////////////
bool TRUTH_Is2ndTrk_maxiumAngle_threshold_No_Neutral_WITHProtonAndPion_thresholds(
    const HeliumCVUniverse& univ,
    double Max_degMax_deg = HeliumCUTConsts::Maximum_secTrkwrtb_GreatestKE,
    double Pion_Energy = HeliumCUTConsts::Truth_pion_Minimum_Energy,
    double Proton_Energy = HeliumCUTConsts::Truth_proton_Minimum_Energy);
////////////////////////////////////////////////////////////////////////////////
bool TRUTH_Is2ndTrk_No_Neutral_WITHProtonAndPion_thresholds(
    const HeliumCVUniverse& univ,
    double Pion_Energy = HeliumCUTConsts::Truth_pion_Minimum_Energy,
    double Proton_Energy = HeliumCUTConsts::Truth_proton_Minimum_Energy);
////////////////////////////////////////////////////////////////////////////////
bool TRUTH_Is2ndTrk_maxiumAngle_threshold_No_Neutral_leading2ndTrk_RECOBRANCH(
    const HeliumCVUniverse& univ,
    double Max_deg = HeliumCUTConsts::Maximum_secTrkwrtb_GreatestKE);
////////////////////////////////////////////////////////////////////////////////
bool TRUTH_Is2ndTrk_maxiumAngle_threshold_No_Neutral_And_KE_proton_pion_thresholdsleading2ndTrk_RECOBRANCH(
    ...
    double Proton_Energy = HeliumCUTConsts::Truth_proton_Minimum_Energy);
////////////////////////////////////////////////////////////////////////////////
bool TRUTH_Is2ndTrk_maxiumAngle_threshold_No_Neutral_And_KE_proton_pion_thresholdsleading2ndTrk_RECOBRANCH_NoOverLayFraction(
    const HeliumCVUniverse& univ,
    double Max_deg = HeliumCUTConsts::Maximum_secTrkwrtb_GreatestKE,
    double Pion_Energy = HeliumCUTConsts::Truth_pion_Minimum_Energy,
    double Proton_Energy = HeliumCUTConsts::Truth_proton_Minimum_Energy);
////////////////////////////////////////////////////////////////////////////////
bool TRUTH_Is2ndTrk_threshold_No_Neutral_leading2ndTrk_RECOBRANCH(
    const HeliumCVUniverse& univ);
////////////////////////////////////////////////////////////////////////////////
