...
void setRedPalette() {
  ...
  if (!initialized) {
    // White -> red
    Double_t stops[NRGBs] = {0.00,  0.125, 0.250, 0.375, 0.500,
                             0.625, 0.750, 0.875, 1.000};
    Double_t red[NRGBs] = {1.00, 1.00, 0.99, 0.99, 0.98,
                           0.94, 0.80, 0.65, 0.40};
    Double_t green[NRGBs] = {0.96, 0.88, 0.73, 0.57, 0.42,
                             0.23, 0.09, 0.06, 0.00};
    Double_t blue[NRGBs] = {0.94, 0.82, 0.63, 0.45, 0.29,
                            0.17, 0.11, 0.08, 0.05};
    int colmin =
...
//======================================================================
void setCorrelationPalette(double whiteFrac) {
...
void setBlackbodyPalette() {
  // Available as gStyle->SetPalette(56) in sufficiently recent versions of
  // ROOT, but not ours
  const int nRGBs = 5;
  const int NCont = 99;
  static bool initialized = false;
...
void myPlotStyle() {
  ...
  gStyle->SetPadBottomMargin(0.095);  //.14
