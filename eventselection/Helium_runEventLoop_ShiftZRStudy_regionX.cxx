...
MnvH1D_3indexMap  Hist_3index_Map_X_XoutsideEdges;
MnvH1D_3indexMap  Hist_3index_Map_Y_XoutsideEdges;
MnvH1D_3indexMap  Hist_3index_Map_R_XoutsideEdges;
MnvH1D_3indexMap  Hist_3index_Map_Z_XoutsideEdges;
MnvH1D_3indexMap  Hist_3index_DistanceEdge_XoutsideEdges;
...
HistFolio_material_type_3indexMap HistFolio_3index_Map_X_XoutsideEdges;
HistFolio_material_type_3indexMap HistFolio_3index_Map_Y_XoutsideEdges;
HistFolio_material_type_3indexMap HistFolio_3index_Map_Z_XoutsideEdges;
HistFolio_material_type_3indexMap HistFolio_3index_Map_R_XoutsideEdges;
...
int fillHisindex = 0;
  ...
  for ( dog = OffSetMapXYZ.begin(); dog != OffSetMapXYZ.end();++dog)
  {
    ...
    sprintf(tempName,"%s_i_j_k_%d_%d_%d","h_offset_Vertex_Y_XoutsideEdges", i,j,k);
    PlotUtils::MnvH1D *hist_Y_XoutsideEdges = new PlotUtils::MnvH1D(tempName, tempName, Vertex_Ybin_vector.size()-1,Vertex_Ybin_vector.data());
    Hist_3index_Map_Y_XoutsideEdges.insert(std::make_pair(ijk, hist_Y_XoutsideEdges ));

    sprintf(tempName,"%s_i_j_k_%d_%d_%d","h_offset_Vertex_X_XoutsideEdges", i,j,k);
    PlotUtils::MnvH1D *hist_X_XoutsideEdges = new PlotUtils::MnvH1D(tempName, tempName, Vertex_Xbin_vector.size()-1,Vertex_Xbin_vector.data());
    Hist_3index_Map_X_XoutsideEdges.insert(std::make_pair(ijk, hist_X_XoutsideEdges ));

    sprintf(tempName,"%s_i_j_k_%d_%d_%d","h_offset_Vertex_R_XoutsideEdges", i,j,k);
    PlotUtils::MnvH1D *hist_R_XoutsideEdges = new PlotUtils::MnvH1D(tempName, tempName, Vertex_Rbin_vector.size()-1,Vertex_Rbin_vector.data());
    Hist_3index_Map_R_XoutsideEdges.insert(std::make_pair(ijk, hist_R_XoutsideEdges ));

    sprintf(tempName,"%s_i_j_k_%d_%d_%d","h_offset_Vertex_Z_XoutsideEdges", i,j,k);
    PlotUtils::MnvH1D *hist_Z_XoutsideEdges = new PlotUtils::MnvH1D(tempName, tempName, Vertex_Zbin_vector.size()-1,Vertex_Zbin_vector.data());
    Hist_3index_Map_Z_XoutsideEdges.insert(std::make_pair(ijk, hist_Z_XoutsideEdges ));

    sprintf(tempName,"%s_i_j_k_%d_%d_%d","h_Map_DistanceEdge_XoutsideEdges", i,j,k);
    PlotUtils::MnvH1D *hist_edge_XoutsideEdges = new PlotUtils::MnvH1D(tempName, tempName, Distance_to_innerTank.size()-1,Distance_to_innerTank.data());
    Hist_3index_DistanceEdge_XoutsideEdges.insert(std::make_pair(ijk, hist_edge_XoutsideEdges ));

    /////////////////////////////////////////////////////////////////////////////

    sprintf(tempName,"%s_i_j_k_%d_%d_%d","h_offset_Vertex_X_XoutsideEdges_Material", i,j,k);
    PlotUtils::HistFolio<PlotUtils::MnvH1D, Material_type> h_CryoVertex_X_Material_XoutsideEdges =
    PlotUtils::HistFolio<PlotUtils::MnvH1D, Material_type>(MaterialGroup_categories, tempName, Vertex_Xbin_vector ,"h_offset_Vertex_X_Material; [mm];Events:");
    HistFolio_3index_Map_X_XoutsideEdges.insert(std::make_pair(ijk, h_CryoVertex_X_Material_XoutsideEdges ));

    sprintf(tempName,"%s_i_j_k_%d_%d_%d","h_offset_Vertex_Y_XoutsideEdges_Material", i,j,k);
    PlotUtils::HistFolio<PlotUtils::MnvH1D, Material_type> h_CryoVertex_Y_Material_XoutsideEdges =
    PlotUtils::HistFolio<PlotUtils::MnvH1D, Material_type>(MaterialGroup_categories, tempName, Vertex_Ybin_vector ,"h_offset_Vertex_Y_Material; [mm];Events:");
    HistFolio_3index_Map_Y_XoutsideEdges.insert(std::make_pair(ijk, h_CryoVertex_Y_Material_XoutsideEdges ));

    sprintf(tempName,"%s_i_j_k_%d_%d_%d","h_offset_Vertex_Z_XoutsideEdges_Material", i,j,k);
    PlotUtils::HistFolio<PlotUtils::MnvH1D, Material_type> h_CryoVertex_Z_Material_XoutsideEdges =
    PlotUtils::HistFolio<PlotUtils::MnvH1D, Material_type>(MaterialGroup_categories, tempName, Vertex_Zbin_vector ,"h_offset_Vertex_Z_Material; [mm];Events:");
    HistFolio_3index_Map_Z_XoutsideEdges.insert(std::make_pair(ijk, h_CryoVertex_Z_Material_XoutsideEdges ));

    sprintf(tempName,"%s_i_j_k_%d_%d_%d","h_offset_Vertex_R_XoutsideEdges_Material", i,j,k);
    PlotUtils::HistFolio<PlotUtils::MnvH1D, Material_type> h_CryoVertex_R_Material_XoutsideEdges =
    PlotUtils::HistFolio<PlotUtils::MnvH1D, Material_type>(MaterialGroup_categories, tempName, Vertex_Rbin_vector ,"h_offset_Vertex_R_Material; [mm];Events:");
    HistFolio_3index_Map_R_XoutsideEdges.insert(std::make_pair(ijk, h_CryoVertex_R_Material_XoutsideEdges ));
          ...
          if(isCV(*universe)){
            ...
            int mapcount_loop =0;
                ...
                //std::cout<<" index = " << mapcount_loop << " key (i,j,k) =  (" << dog->first.i <<" , "<< dog->first.j<< " , "<< dog->first.k  <<")   OffSet (x, y, z) =  (" << dog->second.x << ", " << dog->second.y<< " , "<< dog->second.z <<" ) "<<std::endl;
                  ...
                  CryoTank_REGIONS CryoTankRegion_type = FourVertexXRegion_of_CryoTank(Vertex_X_OffSet);
                  ...
                  else if(CryoTankRegion_type==kXoutsideEdges)
                  {
                    ...
                    Hist_3index_Map_X_XoutsideEdges.at(ijk)->Fill(Vertex_X_OffSet, wgt_minerva_v1);
                    Hist_3index_Map_Y_XoutsideEdges.at(ijk)->Fill(Vertex_Y_OffSet, wgt_minerva_v1);
                    Hist_3index_Map_R_XoutsideEdges.at(ijk)->Fill(Vertex_R_OffSet, wgt_minerva_v1);
                    Hist_3index_Map_Z_XoutsideEdges.at(ijk)->Fill(Vertex_Z_OffSet, wgt_minerva_v1);
                    Hist_3index_DistanceEdge_XoutsideEdges.at(ijk)->Fill(Distance, wgt_minerva_v1);

                    HistFolio_3index_Map_X_XoutsideEdges.at(ijk).GetComponentHist(Material_type_Event)->Fill(Vertex_X_OffSet, wgt_minerva_v1);
                    HistFolio_3index_Map_Y_XoutsideEdges.at(ijk).GetComponentHist(Material_type_Event)->Fill(Vertex_Y_OffSet, wgt_minerva_v1);
                    HistFolio_3index_Map_Z_XoutsideEdges.at(ijk).GetComponentHist(Material_type_Event)->Fill(Vertex_Z_OffSet, wgt_minerva_v1);
                    HistFolio_3index_Map_R_XoutsideEdges.at(ijk).GetComponentHist(Material_type_Event)->Fill(Vertex_R_OffSet, wgt_minerva_v1);
...
if(m_RunCodeWithSystematics==true){sysmatics_status= "All_SysErrorsOn";}
  ...
  if(Run_EventLoopOnGid==true){
    sprintf(outFileName, "%s_%s_%s_%s_OFFSET_regionX_Alwgt.root", "Histograms",c,d,ErrorStatus);
    std::cout << "Writing output file on Grid to: " <<outFileName << std::endl;

  }
  else{
    sprintf(outFileName, "%s/%s_%s_%s_%s_OFFSET_regionX_Alwgt.root", rootpathway, "Histograms",c,d,ErrorStatus);
...
//  Index3 ijk{dog->first.i,dog->first.j,dog->first.k};
  ...
  Hist_3index_Map_X_XoutsideEdges.at(ijk)->Write();
  Hist_3index_Map_Y_XoutsideEdges.at(ijk)->Write();
  Hist_3index_Map_R_XoutsideEdges.at(ijk)->Write();
  Hist_3index_Map_Z_XoutsideEdges.at(ijk)->Write();
  Hist_3index_DistanceEdge_XoutsideEdges.at(ijk)->Write();
  ...
  HistFolio_3index_Map_X_XoutsideEdges.at(ijk).WriteToFile(*outFile);
  HistFolio_3index_Map_Y_XoutsideEdges.at(ijk).WriteToFile(*outFile);
  HistFolio_3index_Map_Z_XoutsideEdges.at(ijk).WriteToFile(*outFile);
  HistFolio_3index_Map_R_XoutsideEdges.at(ijk).WriteToFile(*outFile);
