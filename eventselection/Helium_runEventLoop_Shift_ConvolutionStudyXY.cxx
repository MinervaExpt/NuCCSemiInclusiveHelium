...
double stddev_offset_Finish_vertexZ = 100.0; //48.0;
int stddev_steps = 20;
double mean_offset_Start_vertexZ = -40; //30.0;
double mean_offset_Finish_vertexZ = 80.0; //48.0;
...
//normal_distribution_Map Normal_Xdistrubution_map;


normal_distribution_index4_Map ConvolutedDistrubution_X_indexMap;
normal_distribution_index4_Map ConvolutedDistrubution_Y_indexMap;
int mapcount = 0;
//int NBinZ =NumZSteps;
...
std::cout<<"~~~~~~~~~~~~~~~Checking Map for X and Y Convolution Map  ~~~~~~~~~~~~~~~~~~~~~~~~"<<std::endl;
...
{
std::cout<<"~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"<<std::endl;
std::cout<<" index = " << mapcount << " key (i,j,k m) =  (" << dog->first.i <<", "<< dog->first.j<< ", "<< dog->first.k  << ", "<< dog->first.m << ")" <<std::endl;
//kX  kY,  kZ
mapcount++;
std::cout<<"~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"<<std::endl;
Index4 ijkm{dog->first.i,dog->first.j,dog->first.k,dog->first.m};

for (auto ptr = dog->second.begin(); ptr != dog->second.end(); ptr++) {

std::normal_distribution<double> input(ptr->second.mean, ptr->second.stddev);
if(ptr->first == kX){

std::cout<<"OffSet (meanX, stddevX) =  (" << ptr->second.mean << ", " << ptr->second.stddev<<") "<<std::endl;
  ConvolutedDistrubution_X_indexMap.insert(std::pair<Index4,std::normal_distribution<double>>(ijkm,input));
}
else if(ptr->first == kY){
std::cout<<"OffSet (meanY, stddevY) =  (" << ptr->second.mean << ", " << ptr->second.stddev<<") "<<std::endl;
  ConvolutedDistrubution_Y_indexMap.insert(std::pair<Index4,std::normal_distribution<double>>(ijkm,input));
}
...
{
  Index4 ijk{dog->first.i,dog->first.j,dog->first.k};
  double shift = Normal_distrubution_map[ijk](generator);

std::cout<<" key (i,j,k,m) =  (" << dog->first.i <<" , "<< dog->first.j<< " , "<< dog->first.k  <<"shift = "<< shift << std::endl;
...
// changing x,y,z
MnvH1D_4indexMap  Hist_4index_Map_X;
MnvH1D_4indexMap  Hist_4index_Map_Y;
MnvH1D_4indexMap  Hist_4index_Map_R;
MnvH1D_4indexMap  Hist_4index_Map_Z;
MnvH1D_4indexMap  Hist_4index_DistanceEdge;
MnvH1D_4indexMap  Hist_4index_Map_DistanceupstreamCap_RCut;
MnvH1D_4indexMap  Hist_4index_Map_DistancedownstreamCap_RCut;
MnvH1D_4indexMap  Hist_4index_Map_DistanceupstreamCap;
MnvH1D_4indexMap  Hist_4index_Map_DistancedownstreamCap;


MnvH1D_4indexMap  Hist_4index_Map_X_TRUE;
MnvH1D_4indexMap  Hist_4index_Map_Y_TRUE;
MnvH1D_4indexMap  Hist_4index_Map_R_TRUE;
MnvH1D_4indexMap  Hist_4index_Map_Z_TRUE;
MnvH1D_4indexMap  Hist_4index_Map_Z_RCut_TRUE;
MnvH1D_4indexMap  Hist_4index_Map_Z_RCut;
MnvH1D_4indexMap  Hist_4index_DistanceEdge_TRUE;
MnvH1D_4indexMap  Hist_4index_Map_DistanceupstreamCap_RCut_TRUE;
MnvH1D_4indexMap  Hist_4index_Map_DistancedownstreamCap_RCut_TRUE;
MnvH1D_4indexMap  Hist_4index_Map_DistanceupstreamCap_TRUE;
MnvH1D_4indexMap  Hist_4index_Map_DistancedownstreamCap_TRUE;

MnvH1D_4indexMap  Hist_4index_Map_X_upstreamCap;
MnvH1D_4indexMap  Hist_4index_Map_Y_upstreamCap;
MnvH1D_4indexMap  Hist_4index_Map_R_upstreamCap;
MnvH1D_4indexMap  Hist_4index_Map_Z_upstreamCap;
MnvH1D_4indexMap  Hist_4index_DistanceEdge_upstreamCap;
MnvH1D_4indexMap  Hist_4index_Map_DistanceupstreamCap_upstream_RCut;
MnvH1D_4indexMap  Hist_4index_Map_DistancedownstreamCap_upstream_RCut;
MnvH1D_4indexMap  Hist_4index_Map_DistanceupstreamCap_upstream;
MnvH1D_4indexMap  Hist_4index_Map_DistancedownstreamCap_upstream;

MnvH1D_4indexMap  Hist_4index_Map_X_upstreamCap_TRUE;
MnvH1D_4indexMap  Hist_4index_Map_Y_upstreamCap_TRUE;
MnvH1D_4indexMap  Hist_4index_Map_R_upstreamCap_TRUE;
MnvH1D_4indexMap  Hist_4index_Map_Z_upstreamCap_TRUE;
MnvH1D_4indexMap  Hist_4index_Map_Z_RCut_upstreamCap_TRUE;
MnvH1D_4indexMap  Hist_4index_Map_Z_RCut_upstreamCap;
MnvH1D_4indexMap  Hist_4index_DistanceEdge_upstreamCap_TRUE;
MnvH1D_4indexMap  Hist_4index_Map_DistanceupstreamCap_upstream_RCut_TRUE;
MnvH1D_4indexMap  Hist_4index_Map_DistancedownstreamCap_upstream_RCut_TRUE;
MnvH1D_4indexMap  Hist_4index_Map_DistanceupstreamCap_upstream_TRUE;
MnvH1D_4indexMap  Hist_4index_Map_DistancedownstreamCap_upstream_TRUE;

MnvH1D_4indexMap  Hist_4index_muonE_upstreamCap;
MnvH1D_4indexMap  Hist_4index_PT_upstreamCap;
MnvH1D_4indexMap  Hist_4index_PZ_upstreamCap;
MnvH1D_4indexMap  Hist_4index_muontheta_upstreamCap;
MnvH1D_4indexMap  Hist_4index_muonDoca_upstreamCap;
MnvH1D_4indexMap  Hist_4index_recoilDoca_upstreamCap;
MnvH1D_4indexMap  Hist_4index_Tracklength_upstreamCap;


MnvH1D_4indexMap  Hist_4index_Map_X_barrel;
MnvH1D_4indexMap  Hist_4index_Map_Y_barrel;
MnvH1D_4indexMap  Hist_4index_Map_R_barrel;
MnvH1D_4indexMap  Hist_4index_Map_Z_barrel;
MnvH1D_4indexMap  Hist_4index_DistanceEdge_barrel;
MnvH1D_4indexMap  Hist_4index_Map_DistanceupstreamCap_barrel_RCut;
MnvH1D_4indexMap  Hist_4index_Map_DistancedownstreamCap_barrel_RCut;
MnvH1D_4indexMap  Hist_4index_Map_DistanceupstreamCap_barrel;
MnvH1D_4indexMap  Hist_4index_Map_DistancedownstreamCap_barrel;


MnvH1D_4indexMap  Hist_4index_Map_X_barrel_TRUE;
MnvH1D_4indexMap  Hist_4index_Map_Y_barrel_TRUE;
MnvH1D_4indexMap  Hist_4index_Map_R_barrel_TRUE;
MnvH1D_4indexMap  Hist_4index_Map_Z_barrel_TRUE;
MnvH1D_4indexMap  Hist_4index_Map_Z_RCut_barrel_TRUE;
MnvH1D_4indexMap  Hist_4index_Map_Z_RCut_barrel;
MnvH1D_4indexMap  Hist_4index_DistanceEdge_barrel_TRUE;
MnvH1D_4indexMap  Hist_4index_Map_DistanceupstreamCap_barrel_RCut_TRUE;
MnvH1D_4indexMap  Hist_4index_Map_DistancedownstreamCap_barrel_RCut_TRUE;
MnvH1D_4indexMap  Hist_4index_Map_DistanceupstreamCap_barrel_TRUE;
MnvH1D_4indexMap  Hist_4index_Map_DistancedownstreamCap_barrel_TRUE;

//MnvH1D_4indexMap  Hist_4index_PT_barrel;
//MnvH1D_4indexMap  Hist_4index_PZ_barrel;
//MnvH1D_4indexMap  Hist_4index_muonE_barrel;
//MnvH1D_4indexMap  Hist_4index_muontheta_barrel;
//MnvH1D_4indexMap  Hist_4index_muonDoca_barrel;
//MnvH1D_4indexMap  Hist_4index_recoilDoca_barrel;
//MnvH1D_4indexMap  Hist_4index_Tracklength_barrel;

MnvH1D_4indexMap  Hist_4index_Map_X_downstreamCap;
MnvH1D_4indexMap  Hist_4index_Map_Y_downstreamCap;
MnvH1D_4indexMap  Hist_4index_Map_R_downstreamCap;
MnvH1D_4indexMap  Hist_4index_Map_Z_downstreamCap;
MnvH1D_4indexMap  Hist_4index_DistanceEdge_downstreamCap;
MnvH1D_4indexMap  Hist_4index_Map_DistanceupstreamCap_downstreamCap_RCut;
MnvH1D_4indexMap  Hist_4index_Map_DistancedownstreamCap_downstreamCap_RCut;
MnvH1D_4indexMap  Hist_4index_Map_DistanceupstreamCap_downstreamCap;
MnvH1D_4indexMap  Hist_4index_Map_DistancedownstreamCap_downstreamCap;


MnvH1D_4indexMap  Hist_4index_Map_X_downstreamCap_TRUE;
MnvH1D_4indexMap  Hist_4index_Map_Y_downstreamCap_TRUE;
MnvH1D_4indexMap  Hist_4index_Map_R_downstreamCap_TRUE;
MnvH1D_4indexMap  Hist_4index_Map_Z_downstreamCap_TRUE;
MnvH1D_4indexMap  Hist_4index_Map_Z_RCut_downstreamCap_TRUE;
MnvH1D_4indexMap  Hist_4index_Map_Z_RCut_downstreamCap;
MnvH1D_4indexMap  Hist_4index_DistanceEdge_downstreamCap_TRUE;
MnvH1D_4indexMap  Hist_4index_Map_DistanceupstreamCap_downstreamCap_RCut_TRUE;
MnvH1D_4indexMap  Hist_4index_Map_DistancedownstreamCap_downstreamCap_RCut_TRUE;
MnvH1D_4indexMap  Hist_4index_Map_DistanceupstreamCap_downstreamCap_TRUE;
MnvH1D_4indexMap  Hist_4index_Map_DistancedownstreamCap_downstreamCap_TRUE;
//MnvH1D_4indexMap  Hist_4index_PT_downstreamCap;
//MnvH1D_4indexMap  Hist_4index_muonE_downstreamCap;
//MnvH1D_4indexMap  Hist_4index_PZ_downstreamCap;
//MnvH1D_4indexMap  Hist_4index_muontheta_downstreamCap;
//MnvH1D_4indexMap  Hist_4index_muonDoca_downstreamCap;
//MnvH1D_4indexMap  Hist_4index_recoilDoca_downstreamCap;
//MnvH1D_4indexMap  Hist_4index_Tracklength_downstreamCap;


MnvH1D_4indexMap  Hist_4index_Map_X_downstreamconcavecap;
MnvH1D_4indexMap  Hist_4index_Map_Y_downstreamconcavecap;
MnvH1D_4indexMap  Hist_4index_Map_R_downstreamconcavecap;
MnvH1D_4indexMap  Hist_4index_Map_Z_downstreamconcavecap;
MnvH1D_4indexMap  Hist_4index_DistanceEdge_downstreamconcavecap;
MnvH1D_4indexMap  Hist_4index_Map_DistanceupstreamCap_downstreamconcavecap_RCut;
MnvH1D_4indexMap  Hist_4index_Map_DistancedownstreamCap_downstreamconcavecap_RCut;
MnvH1D_4indexMap  Hist_4index_Map_DistanceupstreamCap_downstreamconcavecap;
MnvH1D_4indexMap  Hist_4index_Map_DistancedownstreamCap_downstreamconcavecap;


MnvH1D_4indexMap  Hist_4index_Map_X_downstreamconcavecap_TRUE;
MnvH1D_4indexMap  Hist_4index_Map_Y_downstreamconcavecap_TRUE;
MnvH1D_4indexMap  Hist_4index_Map_R_downstreamconcavecap_TRUE;
MnvH1D_4indexMap  Hist_4index_Map_Z_downstreamconcavecap_TRUE;
MnvH1D_4indexMap  Hist_4index_Map_Z_RCut_downstreamconcavecap_TRUE;
MnvH1D_4indexMap  Hist_4index_Map_Z_RCut_downstreamconcavecap;
MnvH1D_4indexMap  Hist_4index_DistanceEdge_downstreamconcavecap_TRUE;
MnvH1D_4indexMap  Hist_4index_Map_DistanceupstreamCap_downstreamconcavecap_RCut_TRUE;
MnvH1D_4indexMap  Hist_4index_Map_DistancedownstreamCap_downstreamconcavecap_RCut_TRUE;
MnvH1D_4indexMap  Hist_4index_Map_DistanceupstreamCap_downstreamconcavecap_TRUE;
MnvH1D_4indexMap  Hist_4index_Map_DistancedownstreamCap_downstreamconcavecap_TRUE;
...
HistFolio_material_type_4indexMap HistFolio_4index_Map_X_upstreamcap;
HistFolio_material_type_4indexMap HistFolio_4index_Map_Y_upstreamcap;
HistFolio_material_type_4indexMap HistFolio_4index_Map_Z_upstreamcap;
HistFolio_material_type_4indexMap HistFolio_4index_Map_R_upstreamcap;

HistFolio_material_type_4indexMap HistFolio_4index_Map_X_barrel;
HistFolio_material_type_4indexMap HistFolio_4index_Map_Y_barrel;
HistFolio_material_type_4indexMap HistFolio_4index_Map_Z_barrel;
HistFolio_material_type_4indexMap HistFolio_4index_Map_R_barrel;


HistFolio_material_type_4indexMap HistFolio_4index_Map_X_downstreamcap;
HistFolio_material_type_4indexMap HistFolio_4index_Map_Y_downstreamcap;
HistFolio_material_type_4indexMap HistFolio_4index_Map_Z_downstreamcap;
HistFolio_material_type_4indexMap HistFolio_4index_Map_R_downstreamcap;

HistFolio_material_type_4indexMap HistFolio_4index_Map_X_downstreamconcavecap;
HistFolio_material_type_4indexMap HistFolio_4index_Map_Y_downstreamconcavecap;
HistFolio_material_type_4indexMap HistFolio_4index_Map_Z_downstreamconcavecap;
HistFolio_material_type_4indexMap HistFolio_4index_Map_R_downstreamconcavecap;
...
int fillHisindex = 0;
  ...
  for ( dog = XYShiftMap.begin(); dog != XYShiftMap.end();++dog)
  {
   ...
   Index4 ijkm{dog->first.i,dog->first.j,dog->first.k,dog->first.m};
    ...
    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_Y", i,j,k,m);
    PlotUtils::MnvH1D *hist_Y = new PlotUtils::MnvH1D(tempName, tempName, Vertex_Ybin_vector.size()-1,Vertex_Ybin_vector.data());
    Hist_4index_Map_Y.insert(std::make_pair(ijkm, hist_Y ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_X", i,j,k,m);
    PlotUtils::MnvH1D *hist_X = new PlotUtils::MnvH1D(tempName, tempName, Vertex_Xbin_vector.size()-1,Vertex_Xbin_vector.data());
    Hist_4index_Map_X.insert(std::make_pair(ijkm, hist_X ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_R", i,j,k,m);
    PlotUtils::MnvH1D *hist_R = new PlotUtils::MnvH1D(tempName, tempName, Vertex_Rbin_vector.size()-1,Vertex_Rbin_vector.data());
    Hist_4index_Map_R.insert(std::make_pair(ijkm, hist_R ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_Z", i,j,k,m);
    PlotUtils::MnvH1D *hist_Z = new PlotUtils::MnvH1D(tempName, tempName, Vertex_Zbin_vector.size()-1,Vertex_Zbin_vector.data());
    Hist_4index_Map_Z.insert(std::make_pair(ijkm, hist_Z ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_DistanceEdge", i,j,k,m);
    ...
    Hist_4index_DistanceEdge.insert(std::make_pair(ijkm, hist_DistanceEdge ));
    ...
    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_Y_TRUE", i,j,k,m);
    PlotUtils::MnvH1D *hist_Y_TRUE = new PlotUtils::MnvH1D(tempName, tempName, Vertex_Ybin_vector.size()-1,Vertex_Ybin_vector.data());
    Hist_4index_Map_Y_TRUE.insert(std::make_pair(ijkm, hist_Y_TRUE ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_X_TRUE", i,j,k,m);
    PlotUtils::MnvH1D *hist_X_TRUE = new PlotUtils::MnvH1D(tempName, tempName, Vertex_Xbin_vector.size()-1,Vertex_Xbin_vector.data());
    Hist_4index_Map_X_TRUE.insert(std::make_pair(ijkm, hist_X_TRUE ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_R_TRUE", i,j,k,m);
    PlotUtils::MnvH1D *hist_R_TRUE = new PlotUtils::MnvH1D(tempName, tempName, Vertex_Rbin_vector.size()-1,Vertex_Rbin_vector.data());
    Hist_4index_Map_R_TRUE.insert(std::make_pair(ijkm, hist_R_TRUE ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_Z_TRUE", i,j,k,m);
    PlotUtils::MnvH1D *hist_Z_TRUE = new PlotUtils::MnvH1D(tempName, tempName, Vertex_Zbin_vector.size()-1,Vertex_Zbin_vector.data());
    Hist_4index_Map_Z_TRUE.insert(std::make_pair(ijkm, hist_Z_TRUE ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_Z_RCut_TRUE", i,j,k,m);
    ...
    Hist_4index_Map_Z_RCut_TRUE.insert(std::make_pair(ijkm, hist_Z_RCut_TRUE ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_Z_RCut", i,j,k,m);
    PlotUtils::MnvH1D *hist_Z_RCut = new PlotUtils::MnvH1D(tempName, tempName, Vertex_Zbin_vector.size()-1,Vertex_Zbin_vector.data());
    Hist_4index_Map_Z_RCut.insert(std::make_pair(ijkm, hist_Z_RCut ));


    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_DistanceEdge_TRUE", i,j,k,m);
    ...
    Hist_4index_DistanceEdge_TRUE.insert(std::make_pair(ijkm, hist_DistanceEdge_TRUE ));
    /////////////////////////////////////////////////////////////////////////////////
    //// upstream
    //////////////////////////////////////////////////////////////////////////////

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_X_upstreamCap", i,j,k,m);
    ...
    Hist_4index_Map_X_upstreamCap.insert(std::make_pair(ijkm, hist_X_upstreamCap ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_Y_upstreamCap", i,j,k,m);
    ...
    Hist_4index_Map_Y_upstreamCap.insert(std::make_pair(ijkm, hist_Y_upstreamCap ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_R_upstreamCap", i,j,k,m);
    ...
    Hist_4index_Map_R_upstreamCap.insert(std::make_pair(ijkm, hist_R_upstreamCap ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_Z_upstreamCap", i,j,k,m);
    ...
    Hist_4index_Map_Z_upstreamCap.insert(std::make_pair(ijkm, hist_Z_upstreamCap ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_Map_DistanceEdge_upstreamCap", i,j,k,m);
    ...
    Hist_4index_DistanceEdge_upstreamCap.insert(std::make_pair(ijkm, hist_edge_upstreamCap ));

    ////////////////////////
    //// TRUTH
    //////////////////////

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_X_upstreamCap_TRUE", i,j,k,m);
    ...
    Hist_4index_Map_X_upstreamCap_TRUE.insert(std::make_pair(ijkm, hist_X_upstreamCap_TRUE ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_Y_upstreamCap_TRUE", i,j,k,m);
    ...
    Hist_4index_Map_Y_upstreamCap_TRUE.insert(std::make_pair(ijkm, hist_Y_upstreamCap_TRUE ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_R_upstreamCap_TRUE", i,j,k,m);
    ...
    Hist_4index_Map_R_upstreamCap_TRUE.insert(std::make_pair(ijkm, hist_R_upstreamCap_TRUE ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_Z_upstreamCap_TRUE", i,j,k,m);
    ...
    Hist_4index_Map_Z_upstreamCap_TRUE.insert(std::make_pair(ijkm, hist_Z_upstreamCap_TRUE ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_Z_RCut_upstreamCap_TRUE", i,j,k,m);
    ...
    Hist_4index_Map_Z_RCut_upstreamCap_TRUE.insert(std::make_pair(ijkm, hist_Z_upstreamCap_RCut_TRUE ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_Z_RCut_upstreamCap", i,j,k,m);
    ...
    Hist_4index_Map_Z_RCut_upstreamCap.insert(std::make_pair(ijkm, hist_Z_upstreamCap_RCut ));



    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_Map_DistanceEdge_upstreamCap_TRUE", i,j,k,m);
    ...
    Hist_4index_DistanceEdge_upstreamCap_TRUE.insert(std::make_pair(ijkm, hist_edge_upstreamCap_TRUE ));
...
////////////////////////////////////
    ...
    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d", "h_Map_DistanceupstreamCap_RCut", i,j,k,m);
    ...
    Hist_4index_Map_DistanceupstreamCap_RCut.insert(std::make_pair(ijkm, hist_Distance_upstreamCap_RCut ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d", "h_Map_DistancedownstreamCap_RCut", i,j,k,m);
    ...
    Hist_4index_Map_DistancedownstreamCap_RCut.insert(std::make_pair(ijkm, hist_Distance_downstreamCap_RCut ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d", "h_Map_DistanceupstreamCap_RCut_TRUE", i,j,k,m);
    ...
    Hist_4index_Map_DistanceupstreamCap_RCut_TRUE.insert(std::make_pair(ijkm, hist_Distance_upstreamCap_TRUE_RCut ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d", "h_Map_DistancedownstreamCap_RCut_TRUE", i,j,k,m);
    ...
    Hist_4index_Map_DistancedownstreamCap_RCut_TRUE.insert(std::make_pair(ijkm, hist_Distance_downstreamCap_TRUE_RCut ));


    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_Map_DistanceupstreamCap_RCut_upstreamCap", i,j,k,m);
    ...
    Hist_4index_Map_DistanceupstreamCap_upstream_RCut.insert(std::make_pair(ijkm, hist_upstream_Distance_upstreamCap_RCut ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_Map_DistancedownstreamCap_RCut_upstreamCap", i,j,k,m);
    ...
    Hist_4index_Map_DistancedownstreamCap_upstream_RCut.insert(std::make_pair(ijkm, hist_upstream_Distance_downstreamCap_RCut ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_Map_DistanceupstreamCap_RCut_upstreamCap_TRUE", i,j,k,m);
    ...
    Hist_4index_Map_DistanceupstreamCap_upstream_RCut_TRUE.insert(std::make_pair(ijkm, hist_upstream_Distance_upstreamCap_TRUE_RCut ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_Map_DistancedownstreamCap_RCut_upstreamCap_TRUE", i,j,k,m);
    ...
    Hist_4index_Map_DistancedownstreamCap_upstream_RCut_TRUE.insert(std::make_pair(ijkm, hist_upstream_Distance_downstreamCap_TRUE_RCut ));
    //

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_Map_DistanceupstreamCap_RCut_barrel", i,j,k,m);
    ...
    Hist_4index_Map_DistanceupstreamCap_barrel_RCut.insert(std::make_pair(ijkm, hist_barrel_Distance_upstreamCap_RCut ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_Map_DistancedownstreamCap_RCut_barrel", i,j,k,m);
    ...
    Hist_4index_Map_DistancedownstreamCap_barrel_RCut.insert(std::make_pair(ijkm, hist_barrel_Distance_downstreamCap_RCut ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_Map_DistanceupstreamCap_RCut_barrel_TRUE", i,j,k,m);
    ...
    Hist_4index_Map_DistanceupstreamCap_barrel_RCut_TRUE.insert(std::make_pair(ijkm, hist_barrel_Distance_upstreamCap_TRUE_RCut ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_Map_DistancedownstreamCap_RCut_barrel_TRUE", i,j,k,m);
    ...
    Hist_4index_Map_DistancedownstreamCap_barrel_RCut_TRUE.insert(std::make_pair(ijkm, hist_barrel_Distance_downstreamCap_TRUE_RCut ));

  //

  sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_Map_DistanceupstreamCap_RCut_downstreamCap", i,j,k,m);
  ...
  Hist_4index_Map_DistanceupstreamCap_downstreamCap_RCut.insert(std::make_pair(ijkm, hist_downstreamCap_Distance_upstreamCap_RCut ));

  sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_Map_DistancedownstreamCap_RCut_downstreamCap", i,j,k,m);
  ...
  Hist_4index_Map_DistancedownstreamCap_downstreamCap_RCut.insert(std::make_pair(ijkm, hist_downstreamCap_Distance_downstreamCap_RCut ));

  sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_Map_DistanceupstreamCap_RCut_downstreamCap_TRUE", i,j,k,m);
  ...
  Hist_4index_Map_DistanceupstreamCap_downstreamCap_RCut_TRUE.insert(std::make_pair(ijkm, hist_downstreamCap_Distance_upstreamCap_TRUE_RCut ));

  sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_Map_DistancedownstreamCap_RCut_downstreamCap_TRUE", i,j,k,m);
  ...
  Hist_4index_Map_DistancedownstreamCap_downstreamCap_RCut_TRUE.insert(std::make_pair(ijkm, hist_downstreamCap_Distance_downstreamCap_TRUE_RCut ));
//

//

sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_Map_DistanceupstreamCap_RCut_downstreamConcaveCap", i,j,k,m);
...
Hist_4index_Map_DistanceupstreamCap_downstreamconcavecap_RCut.insert(std::make_pair(ijkm, hist_downstreamconcavecap_Distance_upstreamCap_RCut ));

sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_Map_DistancedownstreamCap_RCut_downstreamConcaveCap", i,j,k,m);
...
Hist_4index_Map_DistancedownstreamCap_downstreamconcavecap_RCut.insert(std::make_pair(ijkm, hist_downstreamconcavecap_Distance_downstreamCap_RCut ));

sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_Map_DistanceupstreamCap_RCut_downstreamConcaveCap_TRUE", i,j,k,m);
...
Hist_4index_Map_DistanceupstreamCap_downstreamconcavecap_RCut_TRUE.insert(std::make_pair(ijkm, hist_downstreamconcavecap_Distance_upstreamCap_TRUE_RCut ));

sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_Map_DistancedownstreamCap_RCut_downstreamConcaveCap_TRUE", i,j,k,m);
...
Hist_4index_Map_DistancedownstreamCap_downstreamconcavecap_RCut_TRUE.insert(std::make_pair(ijkm, hist_downstreamconcavecap_Distance_downstreamCap_TRUE_RCut ));
/////////////////////////////////////
//// no RCut applied
////////////////////////////////////

sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_Map_DistanceupstreamCap", i,j,k,m);
...
Hist_4index_Map_DistanceupstreamCap.insert(std::make_pair(ijkm, hist_Distance_upstreamCap ));

sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_Map_DistancedownstreamCap", i,j,k,m);
...
Hist_4index_Map_DistancedownstreamCap.insert(std::make_pair(ijkm, hist_Distance_downstreamCap ));

sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_Map_DistanceupstreamCap_TRUE", i,j,k,m);
...
Hist_4index_Map_DistanceupstreamCap_TRUE.insert(std::make_pair(ijkm, hist_Distance_upstreamCap_TRUE ));

sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_Map_DistancedownstreamCap_TRUE", i,j,k,m);
...
Hist_4index_Map_DistancedownstreamCap_TRUE.insert(std::make_pair(ijkm, hist_Distance_downstreamCap_TRUE ));

//

sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_Map_DistanceupstreamCap_upstreamCap", i,j,k,m);
...
Hist_4index_Map_DistanceupstreamCap_upstream.insert(std::make_pair(ijkm, hist_upstream_Distance_upstreamCap ));

sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_Map_DistancedownstreamCap_upstreamCap", i,j,k,m);
...
Hist_4index_Map_DistancedownstreamCap_upstream.insert(std::make_pair(ijkm, hist_upstream_Distance_downstreamCap ));

sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_Map_DistanceupstreamCap_upstreamCap_TRUE", i,j,k,m);
...
Hist_4index_Map_DistanceupstreamCap_upstream_TRUE.insert(std::make_pair(ijkm, hist_upstream_Distance_upstreamCap_TRUE ));

sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_Map_DistancedownstreamCap_upstreamCap_TRUE", i,j,k,m);
...
Hist_4index_Map_DistancedownstreamCap_upstream_TRUE.insert(std::make_pair(ijkm, hist_upstream_Distance_downstreamCap_TRUE ));
//

sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_Map_DistanceupstreamCap_barrel", i,j,k,m);
...
Hist_4index_Map_DistanceupstreamCap_barrel.insert(std::make_pair(ijkm, hist_barrel_Distance_upstreamCap ));

sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_Map_DistancedownstreamCap_barrel", i,j,k,m);
...
Hist_4index_Map_DistancedownstreamCap_barrel.insert(std::make_pair(ijkm, hist_barrel_Distance_downstreamCap ));

sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_Map_DistanceupstreamCap_barrel_TRUE", i,j,k,m);
...
Hist_4index_Map_DistanceupstreamCap_barrel_TRUE.insert(std::make_pair(ijkm, hist_barrel_Distance_upstreamCap_TRUE ));

sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_Map_DistancedownstreamCap_barrel_TRUE", i,j,k,m);
...
Hist_4index_Map_DistancedownstreamCap_barrel_TRUE.insert(std::make_pair(ijkm, hist_barrel_Distance_downstreamCap_TRUE ));

//

sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_Map_DistanceupstreamCap_downstreamCap", i,j,k,m);
...
Hist_4index_Map_DistanceupstreamCap_downstreamCap.insert(std::make_pair(ijkm, hist_downstreamCap_Distance_upstreamCap ));

sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_Map_DistancedownstreamCap_downstreamCap", i,j,k,m);
...
Hist_4index_Map_DistancedownstreamCap_downstreamCap.insert(std::make_pair(ijkm, hist_downstreamCap_Distance_downstreamCap ));


sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_Map_DistanceupstreamCap_downstreamCap_TRUE", i,j,k,m);
...
Hist_4index_Map_DistanceupstreamCap_downstreamCap_TRUE.insert(std::make_pair(ijkm, hist_downstreamCap_Distance_upstreamCap_TRUE ));

sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_Map_DistancedownstreamCap_downstreamCap_TRUE", i,j,k,m);
...
Hist_4index_Map_DistancedownstreamCap_downstreamCap_TRUE.insert(std::make_pair(ijkm, hist_downstreamCap_Distance_downstreamCap_TRUE ));
//
//

sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_Map_DistanceupstreamCap_downstreamConcaveCap", i,j,k,m);
...
Hist_4index_Map_DistanceupstreamCap_downstreamconcavecap.insert(std::make_pair(ijkm, hist_downstreamconcavecap_Distance_upstreamCap ));

sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_Map_DistancedownstreamCap_downstreamConcaveCap", i,j,k,m);
...
Hist_4index_Map_DistancedownstreamCap_downstreamconcavecap.insert(std::make_pair(ijkm, hist_downstreamconcavecap_Distance_downstreamCap ));


sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_Map_DistanceupstreamCap_downstreamConcaveCap_TRUE", i,j,k,m);
...
Hist_4index_Map_DistanceupstreamCap_downstreamconcavecap_TRUE.insert(std::make_pair(ijkm, hist_downstreamconcavecap_Distance_upstreamCap_TRUE ));

sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_Map_DistancedownstreamCap_downstreamConcaveCap_TRUE", i,j,k,m);
...
Hist_4index_Map_DistancedownstreamCap_downstreamconcavecap_TRUE.insert(std::make_pair(ijkm, hist_downstreamconcavecap_Distance_downstreamCap_TRUE ));
...
//////////////////////////////////////////////////////////////////////////////
    ...
    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_Y_barrel", i,j,k,m);
    PlotUtils::MnvH1D *hist_Y_barrel = new PlotUtils::MnvH1D(tempName, tempName, Vertex_Ybin_vector.size()-1,Vertex_Ybin_vector.data());
    Hist_4index_Map_Y_barrel.insert(std::make_pair(ijkm, hist_Y_barrel ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_X_barrel", i,j,k,m);
    PlotUtils::MnvH1D *hist_X_barrel = new PlotUtils::MnvH1D(tempName, tempName, Vertex_Xbin_vector.size()-1,Vertex_Xbin_vector.data());
    Hist_4index_Map_X_barrel.insert(std::make_pair(ijkm, hist_X_barrel ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_R_barrel", i,j,k,m);
    PlotUtils::MnvH1D *hist_R_barrel = new PlotUtils::MnvH1D(tempName, tempName, Vertex_Rbin_vector.size()-1,Vertex_Rbin_vector.data());
    Hist_4index_Map_R_barrel.insert(std::make_pair(ijkm, hist_R_barrel ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_Z_barrel", i,j,k,m);
    PlotUtils::MnvH1D *hist_Z_barrel = new PlotUtils::MnvH1D(tempName, tempName, Vertex_Zbin_vector.size()-1,Vertex_Zbin_vector.data());
    Hist_4index_Map_Z_barrel.insert(std::make_pair(ijkm, hist_Z_barrel ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_Map_DistanceEdge_barrel", i,j,k,m);
    ...
    Hist_4index_DistanceEdge_barrel.insert(std::make_pair(ijkm, hist_edge_barrel ));

    /////////////////////////////
    // TRUTH
    ///////////////////////////

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_Y_barrel_TRUE", i,j,k,m);
    ...
    Hist_4index_Map_Y_barrel_TRUE.insert(std::make_pair(ijkm, hist_Y_barrel_TRUE ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_X_barrel_TRUE", i,j,k,m);
    ...
    Hist_4index_Map_X_barrel_TRUE.insert(std::make_pair(ijkm, hist_X_barrel_TRUE ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_R_barrel_TRUE", i,j,k,m);
    ...
    Hist_4index_Map_R_barrel_TRUE.insert(std::make_pair(ijkm, hist_R_barrel_TRUE ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_Z_barrel_TRUE", i,j,k,m);
    ...
    Hist_4index_Map_Z_barrel_TRUE.insert(std::make_pair(ijkm, hist_Z_barrel_TRUE ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_Z_RCut_barrel_TRUE", i,j,k,m);
    ...
    Hist_4index_Map_Z_RCut_barrel_TRUE.insert(std::make_pair(ijkm, hist_Z_RCut_barrel_TRUE ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_Z_RCut_barrel", i,j,k,m);
    ...
    Hist_4index_Map_Z_RCut_barrel.insert(std::make_pair(ijkm, hist_Z_RCut_barrel ));



    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_Map_DistanceEdge_barrel_TRUE", i,j,k,m);
    ...
    Hist_4index_DistanceEdge_barrel_TRUE.insert(std::make_pair(ijkm, hist_edge_barrel_TRUE ));
    ...
    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_Y_downstreamCap", i,j,k,m);
    ...
    Hist_4index_Map_Y_downstreamCap.insert(std::make_pair(ijkm, hist_Y_downstreamCap ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_X_downstreamCap", i,j,k,m);
    ...
    Hist_4index_Map_X_downstreamCap.insert(std::make_pair(ijkm, hist_X_downstreamCap ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_R_downstreamCap", i,j,k,m);
    ...
    Hist_4index_Map_R_downstreamCap.insert(std::make_pair(ijkm, hist_R_downstreamCap ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_Z_downstreamCap", i,j,k,m);
    ...
    Hist_4index_Map_Z_downstreamCap.insert(std::make_pair(ijkm, hist_Z_downstreamCap ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_Map_DistanceEdge_downstreamCap", i,j,k,m);
    ...
    Hist_4index_DistanceEdge_downstreamCap.insert(std::make_pair(ijkm, hist_edge_downstreamCap ));

    ///////////////////////
    /// TRUTH
    /////////////////////
    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_Y_downstreamCap_TRUE", i,j,k,m);
    ...
    Hist_4index_Map_Y_downstreamCap_TRUE.insert(std::make_pair(ijkm, hist_Y_downstreamCap_TRUE ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_X_downstreamCap_TRUE", i,j,k,m);
    ...
    Hist_4index_Map_X_downstreamCap_TRUE.insert(std::make_pair(ijkm, hist_X_downstreamCap_TRUE ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_R_downstreamCap_TRUE", i,j,k,m);
    ...
    Hist_4index_Map_R_downstreamCap_TRUE.insert(std::make_pair(ijkm, hist_R_downstreamCap_TRUE ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_Z_downstreamCap_TRUE", i,j,k,m);
    ...
    Hist_4index_Map_Z_downstreamCap_TRUE.insert(std::make_pair(ijkm, hist_Z_downstreamCap_TRUE ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_Z_RCut_downstreamCap_TRUE", i,j,k,m);
    ...
    Hist_4index_Map_Z_RCut_downstreamCap_TRUE.insert(std::make_pair(ijkm, hist_Z_RCut_downstreamCap_TRUE ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_Z_RCut_downstreamCap", i,j,k,m);
    ...
    Hist_4index_Map_Z_RCut_downstreamCap.insert(std::make_pair(ijkm, hist_Z_RCut_downstreamCap ));



    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_Map_DistanceEdge_downstreamCap_TRUE", i,j,k,m);
    ...
    Hist_4index_DistanceEdge_downstreamCap_TRUE.insert(std::make_pair(ijkm, hist_edge_downstreamCap_TRUE ));
    ...
    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_Y_downstreamConcaveCap", i,j,k,m);
    ...
    Hist_4index_Map_Y_downstreamconcavecap.insert(std::make_pair(ijkm, hist_Y_downstreamconcavecap ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_X_downstreamConcaveCap", i,j,k,m);
    ...
    Hist_4index_Map_X_downstreamconcavecap.insert(std::make_pair(ijkm, hist_X_downstreamconcavecap ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_R_downstreamConcaveCap", i,j,k,m);
    ...
    Hist_4index_Map_R_downstreamconcavecap.insert(std::make_pair(ijkm, hist_R_downstreamconcavecap ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_Z_downstreamConcaveCap", i,j,k,m);
    ...
    Hist_4index_Map_Z_downstreamconcavecap.insert(std::make_pair(ijkm, hist_Z_downstreamconcavecap ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_Map_DistanceEdge_downstreamConcaveCap", i,j,k,m);
    ...
    Hist_4index_DistanceEdge_downstreamconcavecap.insert(std::make_pair(ijkm, hist_edge_downstreamconcavecap ));

    //////////////
    /// TRUTH
    //////////////

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_Y_downstreamConcaveCap_TRUE", i,j,k,m);
    ...
    Hist_4index_Map_Y_downstreamconcavecap_TRUE.insert(std::make_pair(ijkm, hist_Y_downstreamconcavecap_TRUE ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_X_downstreamConcaveCap_TRUE", i,j,k,m);
    ...
    Hist_4index_Map_X_downstreamconcavecap_TRUE.insert(std::make_pair(ijkm, hist_X_downstreamconcavecap_TRUE ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_R_downstreamConcaveCap_TRUE", i,j,k,m);
    ...
    Hist_4index_Map_R_downstreamconcavecap_TRUE.insert(std::make_pair(ijkm, hist_R_downstreamconcavecap_TRUE ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_Z_downstreamConcaveCap_TRUE", i,j,k,m);
    ...
    Hist_4index_Map_Z_downstreamconcavecap_TRUE.insert(std::make_pair(ijkm, hist_Z_downstreamconcavecap_TRUE ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_Z_RCut_downstreamConcaveCap_TRUE", i,j,k,m);
    ...
    Hist_4index_Map_Z_RCut_downstreamconcavecap_TRUE.insert(std::make_pair(ijkm, hist_Z_RCut_downstreamconcavecap_TRUE ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_Z_RCut_downstreamConcaveCap", i,j,k,m);
    ...
    Hist_4index_Map_Z_RCut_downstreamconcavecap.insert(std::make_pair(ijkm, hist_Z_RCut_downstreamconcavecap ));


    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_Map_DistanceEdge_downstreamConcaveCap_TRUE", i,j,k,m);
    ...
    Hist_4index_DistanceEdge_downstreamconcavecap_TRUE.insert(std::make_pair(ijkm, hist_edge_downstreamconcavecap_TRUE ));
...
///////////////////////////////////////////////////////////////////////
    ...
    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_Map_DistanceEdge", i,j,k,m);
    ...
    Hist_4index_DistanceEdge.insert(std::make_pair(ijkm, hist_edge ));

    /////////
    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_X_upstreamcap_Material", i,j,k,m);
    ...
    HistFolio_4index_Map_X_upstreamcap.insert(std::make_pair(ijkm, h_CryoVertex_X_Material_upstreamcap ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_Y_upstreamcap_Material", i,j,k,m);
    ...
    HistFolio_4index_Map_Y_upstreamcap.insert(std::make_pair(ijkm, h_CryoVertex_Y_Material_upstreamcap ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_Z_upstreamcap_Material", i,j,k,m);
    ...
    HistFolio_4index_Map_Z_upstreamcap.insert(std::make_pair(ijkm, h_CryoVertex_Z_Material_upstreamcap ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_R_upstreamcap_Material", i,j,k,m);
    ...
    HistFolio_4index_Map_R_upstreamcap.insert(std::make_pair(ijkm, h_CryoVertex_R_Material_upstreamcap ));
    ...
    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_X_barrel_Material", i,j,k,m);
    PlotUtils::HistFolio<PlotUtils::MnvH1D, Material_type> h_CryoVertex_X_Material_barrel =
    PlotUtils::HistFolio<PlotUtils::MnvH1D, Material_type>(MaterialGroup_categories, tempName, Vertex_Xbin_vector ,"h_offset_Vertex_X_Material; [mm];Events:");
    HistFolio_4index_Map_X_barrel.insert(std::make_pair(ijkm, h_CryoVertex_X_Material_barrel ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_Y_barrel_Material", i,j,k,m);
    PlotUtils::HistFolio<PlotUtils::MnvH1D, Material_type> h_CryoVertex_Y_Material_barrel =
    PlotUtils::HistFolio<PlotUtils::MnvH1D, Material_type>(MaterialGroup_categories, tempName, Vertex_Ybin_vector ,"h_offset_Vertex_Y_Material; [mm];Events:");
    HistFolio_4index_Map_Y_barrel.insert(std::make_pair(ijkm, h_CryoVertex_Y_Material_barrel ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_Z_barrel_Material", i,j,k,m);
    PlotUtils::HistFolio<PlotUtils::MnvH1D, Material_type> h_CryoVertex_Z_Material_barrel =
    PlotUtils::HistFolio<PlotUtils::MnvH1D, Material_type>(MaterialGroup_categories, tempName, Vertex_Zbin_vector ,"h_offset_Vertex_Z_Material; [mm];Events:");
    HistFolio_4index_Map_Z_barrel.insert(std::make_pair(ijkm, h_CryoVertex_Z_Material_barrel ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_R_barrel_Material", i,j,k,m);
    PlotUtils::HistFolio<PlotUtils::MnvH1D, Material_type> h_CryoVertex_R_Material_barrel =
    PlotUtils::HistFolio<PlotUtils::MnvH1D, Material_type>(MaterialGroup_categories, tempName, Vertex_Rbin_vector ,"h_offset_Vertex_R_Material; [mm];Events:");
    HistFolio_4index_Map_R_barrel.insert(std::make_pair(ijkm, h_CryoVertex_R_Material_barrel ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_X_downstreamcap_Material", i,j,k,m);
    PlotUtils::HistFolio<PlotUtils::MnvH1D, Material_type> h_CryoVertex_X_Material_downstreamcap =
    PlotUtils::HistFolio<PlotUtils::MnvH1D, Material_type>(MaterialGroup_categories, tempName, Vertex_Xbin_vector ,"h_offset_Vertex_x_Material; [mm];Events:");
    HistFolio_4index_Map_X_downstreamcap.insert(std::make_pair(ijkm, h_CryoVertex_X_Material_downstreamcap ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_Y_downstreamcap_Material", i,j,k,m);
    PlotUtils::HistFolio<PlotUtils::MnvH1D, Material_type> h_CryoVertex_Y_Material_downstreamcap =
    PlotUtils::HistFolio<PlotUtils::MnvH1D, Material_type>(MaterialGroup_categories, tempName, Vertex_Ybin_vector ,"h_offset_Vertex_Y_Material; [mm];Events:");
    HistFolio_4index_Map_Y_downstreamcap.insert(std::make_pair(ijkm, h_CryoVertex_Y_Material_downstreamcap ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_Z_downstreamcap_Material", i,j,k,m);
    PlotUtils::HistFolio<PlotUtils::MnvH1D, Material_type> h_CryoVertex_Z_Material_downstreamcap =
    PlotUtils::HistFolio<PlotUtils::MnvH1D, Material_type>(MaterialGroup_categories, tempName, Vertex_Zbin_vector ,"h_offset_Vertex_Z_Material; [mm];Events:");
    HistFolio_4index_Map_Z_downstreamcap.insert(std::make_pair(ijkm, h_CryoVertex_Z_Material_downstreamcap ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_R_downstreamcap_Material", i,j,k,m);
    PlotUtils::HistFolio<PlotUtils::MnvH1D, Material_type> h_CryoVertex_R_Material_downstreamcap =
    PlotUtils::HistFolio<PlotUtils::MnvH1D, Material_type>(MaterialGroup_categories, tempName, Vertex_Rbin_vector ,"h_offset_Vertex_R_Material; [mm];Events:");
    HistFolio_4index_Map_R_downstreamcap.insert(std::make_pair(ijkm, h_CryoVertex_R_Material_downstreamcap ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_X_downstreamconcavecap_Material", i,j,k,m);
        PlotUtils::HistFolio<PlotUtils::MnvH1D, Material_type> h_CryoVertex_X_Material_downstreamconcavecap =
        PlotUtils::HistFolio<PlotUtils::MnvH1D, Material_type>(MaterialGroup_categories, tempName, Vertex_Xbin_vector ,"h_offset_Vertex_X_Material; [mm];Events:");
        HistFolio_4index_Map_X_downstreamconcavecap.insert(std::make_pair(ijkm, h_CryoVertex_X_Material_downstreamconcavecap ));

    sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_Y_downstreamconcavecap_Material", i,j,k,m);
        PlotUtils::HistFolio<PlotUtils::MnvH1D, Material_type> h_CryoVertex_Y_Material_downstreamconcavecap =
        PlotUtils::HistFolio<PlotUtils::MnvH1D, Material_type>(MaterialGroup_categories, tempName, Vertex_Ybin_vector ,"h_offset_Vertex_Y_Material; [mm];Events:");
        HistFolio_4index_Map_Y_downstreamconcavecap.insert(std::make_pair(ijkm, h_CryoVertex_Y_Material_downstreamconcavecap ));

        sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_Z_downstreamconcavecap_Material", i,j,k,m);
        PlotUtils::HistFolio<PlotUtils::MnvH1D, Material_type> h_CryoVertex_Z_Material_downstreamconcavecap =
        PlotUtils::HistFolio<PlotUtils::MnvH1D, Material_type>(MaterialGroup_categories, tempName, Vertex_Zbin_vector ,"h_offset_Vertex_Z_Material; [mm];Events:");
        HistFolio_4index_Map_Z_downstreamconcavecap.insert(std::make_pair(ijkm, h_CryoVertex_Z_Material_downstreamconcavecap ));

        sprintf(tempName,"%s_i_j_k_m_%d_%d_%d_%d","h_offset_Vertex_R_downstreamconcavecap_Material", i,j,k,m);
        PlotUtils::HistFolio<PlotUtils::MnvH1D, Material_type> h_CryoVertex_R_Material_downstreamconcavecap =
        PlotUtils::HistFolio<PlotUtils::MnvH1D, Material_type>(MaterialGroup_categories, tempName, Vertex_Rbin_vector ,"h_offset_Vertex_R_Material; [mm];Events:");
        HistFolio_4index_Map_R_downstreamconcavecap.insert(std::make_pair(ijkm, h_CryoVertex_R_Material_downstreamconcavecap ));


    //if(fillHisindex%25==0)
    std::cout<< "Finished (" << fillHisindex  <<  ")Set for index = (i, j, k, m) = (" << i <<" , "<< j<< " , "<< k <<", " <<  m  <<" ) " <<std::endl;
        ...
        for (auto universe : Universe_GROUP){
          ...
          if(isCV(*universe)){
            ...
            for ( dog = XYShiftMap.begin(); dog != XYShiftMap.end();++dog)
            {
              ...
              double shiftX = ConvolutedDistrubution_X_indexMap[ijkm](Random_generator);
              double shiftY = ConvolutedDistrubution_Y_indexMap[ijkm](Random_generator);
            //  std::cout<<"Shift X " <<  shiftX << std::endl;
            //  std::cout<<"Shift Y " <<  shiftY << std::endl;

              double Vertex_Z_OffSet = z;
              double Vertex_X_OffSet = x + shiftX;
              double Vertex_Y_OffSet = y + shiftY;
              ...
              //std::cout<<" index = " << mapcount << " key (i,j,k,m) =  (" << dog->first.i <<" , "<< dog->first.j<< " , "<< dog->first.k  <<")   OffSet (mean, stddev) =  ( " << dog->second.mean << " , " << dog->second.stddev <<" ) "<<std::endl;
              ...
              Hist_4index_Map_Z.at(ijkm)->Fill(Vertex_Z_OffSet, wgt_minerva_v1);
              Hist_4index_Map_Y.at(ijkm)->Fill(Vertex_Y_OffSet, wgt_minerva_v1);
              Hist_4index_Map_X.at(ijkm)->Fill(Vertex_X_OffSet, wgt_minerva_v1);
              Hist_4index_Map_R.at(ijkm)->Fill(Vertex_R_OffSet, wgt_minerva_v1);
              Hist_4index_DistanceEdge.at(ijkm)->Fill(Distance_shift, wgt_minerva_v1);

              Hist_4index_Map_Z_TRUE.at(ijkm)->Fill(Vertex_Z_OffSet_TRUE, wgt_minerva_v1);
              Hist_4index_Map_Y_TRUE.at(ijkm)->Fill(Vertex_Y_OffSet_TRUE, wgt_minerva_v1);
              Hist_4index_Map_X_TRUE.at(ijkm)->Fill(Vertex_X_OffSet_TRUE, wgt_minerva_v1);
              Hist_4index_Map_R_TRUE.at(ijkm)->Fill(Vertex_R_OffSet_TRUE, wgt_minerva_v1);
              Hist_4index_DistanceEdge_TRUE.at(ijkm)->Fill(Distance_TRUE_shift, wgt_minerva_v1);


              Hist_4index_Map_DistanceupstreamCap.at(ijkm)->Fill(dist_upstreamCap_shift ,wgt_minerva_v1);
              Hist_4index_Map_DistancedownstreamCap.at(ijkm)->Fill(dist_downstreamCap_shift, wgt_minerva_v1);
              Hist_4index_Map_DistanceupstreamCap_TRUE.at(ijkm)->Fill(dist_upstreamCap_TRUE_shift, wgt_minerva_v1);
              Hist_4index_Map_DistancedownstreamCap_TRUE.at(ijkm)->Fill(dist_downstreamCap_TRUE_shift, wgt_minerva_v1);



              if(Cylindrical_CutAboutZero(Vertex_R_OffSet)== true){

                Hist_4index_Map_DistanceupstreamCap_RCut.at(ijkm)->Fill(dist_upstreamCap_shift ,wgt_minerva_v1);
                Hist_4index_Map_DistancedownstreamCap_RCut.at(ijkm)->Fill(dist_downstreamCap_shift, wgt_minerva_v1);
                Hist_4index_Map_DistanceupstreamCap_RCut_TRUE.at(ijkm)->Fill(dist_upstreamCap_TRUE_shift, wgt_minerva_v1);
                Hist_4index_Map_DistancedownstreamCap_RCut_TRUE.at(ijkm)->Fill(dist_downstreamCap_TRUE_shift, wgt_minerva_v1);
                Hist_4index_Map_Z_RCut_TRUE.at(ijkm)->Fill(Vertex_Z_OffSet_TRUE, wgt_minerva_v1);
                Hist_4index_Map_Z_RCut.at(ijkm)->Fill(Vertex_Z_OffSet, wgt_minerva_v1);
              ...
              if(CryoTankRegion_type==kUpstream_head)
              {
                ...
                Hist_4index_Map_X_upstreamCap.at(ijkm)->Fill(Vertex_X_OffSet, wgt_minerva_v1);
                Hist_4index_Map_Y_upstreamCap.at(ijkm)->Fill(Vertex_Y_OffSet, wgt_minerva_v1);
                Hist_4index_Map_R_upstreamCap.at(ijkm)->Fill(Vertex_R_OffSet, wgt_minerva_v1);
                Hist_4index_Map_Z_upstreamCap.at(ijkm)->Fill(Vertex_Z_OffSet, wgt_minerva_v1);
                Hist_4index_DistanceEdge_upstreamCap.at(ijkm)->Fill(Distance_shift, wgt_minerva_v1);

                Hist_4index_Map_X_upstreamCap_TRUE.at(ijkm)->Fill(Vertex_X_OffSet_TRUE, wgt_minerva_v1);
                Hist_4index_Map_Y_upstreamCap_TRUE.at(ijkm)->Fill(Vertex_Y_OffSet_TRUE, wgt_minerva_v1);
                Hist_4index_Map_R_upstreamCap_TRUE.at(ijkm)->Fill(Vertex_R_OffSet_TRUE, wgt_minerva_v1);
                Hist_4index_Map_Z_upstreamCap_TRUE.at(ijkm)->Fill(Vertex_Z_OffSet_TRUE, wgt_minerva_v1);
                Hist_4index_DistanceEdge_upstreamCap_TRUE.at(ijkm)->Fill(Distance_TRUE_shift, wgt_minerva_v1);

                Hist_4index_Map_DistanceupstreamCap_upstream.at(ijkm)->Fill(dist_upstreamCap_shift, wgt_minerva_v1);
                Hist_4index_Map_DistancedownstreamCap_upstream.at(ijkm)->Fill(dist_downstreamCap_shift, wgt_minerva_v1);
                Hist_4index_Map_DistanceupstreamCap_upstream_TRUE.at(ijkm)->Fill(dist_upstreamCap_TRUE_shift, wgt_minerva_v1);
                Hist_4index_Map_DistancedownstreamCap_upstream_TRUE.at(ijkm)->Fill(dist_downstreamCap_TRUE_shift, wgt_minerva_v1);

                HistFolio_4index_Map_X_upstreamcap.at(ijkm).GetComponentHist(Material_type_Event)->Fill(Vertex_X_OffSet, wgt_minerva_v1);
                HistFolio_4index_Map_Y_upstreamcap.at(ijkm).GetComponentHist(Material_type_Event)->Fill(Vertex_Y_OffSet, wgt_minerva_v1);
                HistFolio_4index_Map_Z_upstreamcap.at(ijkm).GetComponentHist(Material_type_Event)->Fill(Vertex_Z_OffSet, wgt_minerva_v1);
                HistFolio_4index_Map_R_upstreamcap.at(ijkm).GetComponentHist(Material_type_Event)->Fill(Vertex_R_OffSet, wgt_minerva_v1);




                if(Cylindrical_CutAboutZero(Vertex_R_OffSet)== true){
                  Hist_4index_Map_DistanceupstreamCap_upstream_RCut.at(ijkm)->Fill(dist_upstreamCap_shift, wgt_minerva_v1);
                  Hist_4index_Map_DistancedownstreamCap_upstream_RCut.at(ijkm)->Fill(dist_downstreamCap_shift, wgt_minerva_v1);
                  Hist_4index_Map_DistanceupstreamCap_upstream_RCut_TRUE.at(ijkm)->Fill(dist_upstreamCap_TRUE_shift, wgt_minerva_v1);
                  Hist_4index_Map_DistancedownstreamCap_upstream_RCut_TRUE.at(ijkm)->Fill(dist_downstreamCap_TRUE_shift, wgt_minerva_v1);
                  Hist_4index_Map_Z_RCut_upstreamCap_TRUE.at(ijkm)->Fill(Vertex_Z_OffSet_TRUE, wgt_minerva_v1);
                  Hist_4index_Map_Z_RCut_upstreamCap.at(ijkm)->Fill(Vertex_Z_OffSet, wgt_minerva_v1);
                }
              ...
              {
                Hist_4index_Map_X_barrel.at(ijkm)->Fill(Vertex_X_OffSet, wgt_minerva_v1);
                Hist_4index_Map_Y_barrel.at(ijkm)->Fill(Vertex_Y_OffSet, wgt_minerva_v1);
                Hist_4index_Map_R_barrel.at(ijkm)->Fill(Vertex_R_OffSet, wgt_minerva_v1);
                Hist_4index_Map_Z_barrel.at(ijkm)->Fill(Vertex_Z_OffSet, wgt_minerva_v1);
                Hist_4index_DistanceEdge_barrel.at(ijkm)->Fill(Distance_shift, wgt_minerva_v1);

                Hist_4index_Map_X_barrel_TRUE.at(ijkm)->Fill(Vertex_X_OffSet_TRUE, wgt_minerva_v1);
                Hist_4index_Map_Y_barrel_TRUE.at(ijkm)->Fill(Vertex_Y_OffSet_TRUE, wgt_minerva_v1);
                Hist_4index_Map_R_barrel_TRUE.at(ijkm)->Fill(Vertex_R_OffSet_TRUE, wgt_minerva_v1);
                Hist_4index_Map_Z_barrel_TRUE.at(ijkm)->Fill(Vertex_Z_OffSet_TRUE, wgt_minerva_v1);
                Hist_4index_DistanceEdge_barrel_TRUE.at(ijkm)->Fill(Distance_TRUE_shift, wgt_minerva_v1);

                Hist_4index_Map_DistanceupstreamCap_barrel.at(ijkm)->Fill(dist_upstreamCap_shift, wgt_minerva_v1);
                Hist_4index_Map_DistancedownstreamCap_barrel.at(ijkm)->Fill(dist_downstreamCap_shift, wgt_minerva_v1);
                Hist_4index_Map_DistanceupstreamCap_barrel_TRUE.at(ijkm)->Fill(dist_upstreamCap_TRUE_shift, wgt_minerva_v1);
                Hist_4index_Map_DistancedownstreamCap_barrel_TRUE.at(ijkm)->Fill(dist_downstreamCap_TRUE_shift, wgt_minerva_v1);


                HistFolio_4index_Map_X_barrel.at(ijkm).GetComponentHist(Material_type_Event)->Fill(Vertex_X_OffSet, wgt_minerva_v1);
                HistFolio_4index_Map_Y_barrel.at(ijkm).GetComponentHist(Material_type_Event)->Fill(Vertex_Y_OffSet, wgt_minerva_v1);
                HistFolio_4index_Map_Z_barrel.at(ijkm).GetComponentHist(Material_type_Event)->Fill(Vertex_Z_OffSet, wgt_minerva_v1);
                HistFolio_4index_Map_R_barrel.at(ijkm).GetComponentHist(Material_type_Event)->Fill(Vertex_R_OffSet, wgt_minerva_v1);



                if(Cylindrical_CutAboutZero(Vertex_R_OffSet)== true){
                  Hist_4index_Map_Z_RCut_barrel_TRUE.at(ijkm)->Fill(Vertex_Z_OffSet_TRUE, wgt_minerva_v1);
                  Hist_4index_Map_Z_RCut_barrel.at(ijkm)->Fill(Vertex_Z_OffSet, wgt_minerva_v1);

                  Hist_4index_Map_DistanceupstreamCap_barrel_RCut.at(ijkm)->Fill(dist_upstreamCap_shift, wgt_minerva_v1);
                  Hist_4index_Map_DistancedownstreamCap_barrel_RCut.at(ijkm)->Fill(dist_downstreamCap_shift, wgt_minerva_v1);
                  Hist_4index_Map_DistanceupstreamCap_barrel_RCut_TRUE.at(ijkm)->Fill(dist_upstreamCap_TRUE_shift, wgt_minerva_v1);
                  Hist_4index_Map_DistancedownstreamCap_barrel_RCut_TRUE.at(ijkm)->Fill(dist_downstreamCap_TRUE_shift, wgt_minerva_v1);
                }
              ...
              else if(CryoTankRegion_type==kDownstream_head)
              {
                ...
                Hist_4index_Map_X_downstreamCap.at(ijkm)->Fill(Vertex_X_OffSet, wgt_minerva_v1);
                Hist_4index_Map_Y_downstreamCap.at(ijkm)->Fill(Vertex_Y_OffSet, wgt_minerva_v1);
                Hist_4index_Map_R_downstreamCap.at(ijkm)->Fill(Vertex_R_OffSet, wgt_minerva_v1);
                Hist_4index_Map_Z_downstreamCap.at(ijkm)->Fill(Vertex_Z_OffSet, wgt_minerva_v1);
                Hist_4index_DistanceEdge_downstreamCap.at(ijkm)->Fill(Distance_shift, wgt_minerva_v1);

                Hist_4index_Map_X_downstreamCap_TRUE.at(ijkm)->Fill(Vertex_X_OffSet_TRUE, wgt_minerva_v1);
                Hist_4index_Map_Y_downstreamCap_TRUE.at(ijkm)->Fill(Vertex_Y_OffSet_TRUE, wgt_minerva_v1);
                Hist_4index_Map_R_downstreamCap_TRUE.at(ijkm)->Fill(Vertex_R_OffSet_TRUE, wgt_minerva_v1);
                Hist_4index_Map_Z_downstreamCap_TRUE.at(ijkm)->Fill(Vertex_Z_OffSet_TRUE, wgt_minerva_v1);
                Hist_4index_DistanceEdge_downstreamCap_TRUE.at(ijkm)->Fill(Distance_TRUE_shift, wgt_minerva_v1);

                Hist_4index_Map_DistanceupstreamCap_downstreamCap.at(ijkm)->Fill(dist_upstreamCap_shift ,wgt_minerva_v1);
                Hist_4index_Map_DistancedownstreamCap_downstreamCap.at(ijkm)->Fill(dist_downstreamCap_shift, wgt_minerva_v1);
                Hist_4index_Map_DistanceupstreamCap_downstreamCap_TRUE.at(ijkm)->Fill(dist_upstreamCap_TRUE_shift, wgt_minerva_v1);
                Hist_4index_Map_DistancedownstreamCap_downstreamCap_TRUE.at(ijkm)->Fill(dist_downstreamCap_TRUE_shift, wgt_minerva_v1);

                HistFolio_4index_Map_X_downstreamcap.at(ijkm).GetComponentHist(Material_type_Event)->Fill(Vertex_X_OffSet, wgt_minerva_v1);
                HistFolio_4index_Map_Y_downstreamcap.at(ijkm).GetComponentHist(Material_type_Event)->Fill(Vertex_Y_OffSet, wgt_minerva_v1);
                HistFolio_4index_Map_Z_downstreamcap.at(ijkm).GetComponentHist(Material_type_Event)->Fill(Vertex_Z_OffSet, wgt_minerva_v1);
                HistFolio_4index_Map_R_downstreamcap.at(ijkm).GetComponentHist(Material_type_Event)->Fill(Vertex_R_OffSet, wgt_minerva_v1);


                if(Cylindrical_CutAboutZero(Vertex_R_OffSet)== true){
                  Hist_4index_Map_DistanceupstreamCap_downstreamCap_RCut.at(ijkm)->Fill(dist_upstreamCap_shift ,wgt_minerva_v1);
                  Hist_4index_Map_DistancedownstreamCap_downstreamCap_RCut.at(ijkm)->Fill(dist_downstreamCap_shift, wgt_minerva_v1);
                  Hist_4index_Map_DistanceupstreamCap_downstreamCap_RCut_TRUE.at(ijkm)->Fill(dist_upstreamCap_TRUE_shift, wgt_minerva_v1);
                  Hist_4index_Map_DistancedownstreamCap_downstreamCap_RCut_TRUE.at(ijkm)->Fill(dist_downstreamCap_TRUE_shift, wgt_minerva_v1);
                  Hist_4index_Map_Z_RCut_downstreamCap_TRUE.at(ijkm)->Fill(Vertex_Z_OffSet_TRUE, wgt_minerva_v1);
                  Hist_4index_Map_Z_RCut_downstreamCap.at(ijkm)->Fill(Vertex_Z_OffSet, wgt_minerva_v1);
              ...
              {
                Hist_4index_Map_X_downstreamconcavecap.at(ijkm)->Fill(Vertex_X_OffSet, wgt_minerva_v1);
                Hist_4index_Map_Y_downstreamconcavecap.at(ijkm)->Fill(Vertex_Y_OffSet, wgt_minerva_v1);
                Hist_4index_Map_R_downstreamconcavecap.at(ijkm)->Fill(Vertex_R_OffSet, wgt_minerva_v1);
                Hist_4index_Map_Z_downstreamconcavecap.at(ijkm)->Fill(Vertex_Z_OffSet, wgt_minerva_v1);
                Hist_4index_DistanceEdge_downstreamconcavecap.at(ijkm)->Fill(Distance_shift, wgt_minerva_v1);

                Hist_4index_Map_X_downstreamconcavecap_TRUE.at(ijkm)->Fill(Vertex_X_OffSet_TRUE, wgt_minerva_v1);
                Hist_4index_Map_Y_downstreamconcavecap_TRUE.at(ijkm)->Fill(Vertex_Y_OffSet_TRUE, wgt_minerva_v1);
                Hist_4index_Map_R_downstreamconcavecap_TRUE.at(ijkm)->Fill(Vertex_R_OffSet_TRUE, wgt_minerva_v1);
                Hist_4index_Map_Z_downstreamconcavecap_TRUE.at(ijkm)->Fill(Vertex_Z_OffSet_TRUE, wgt_minerva_v1);
                Hist_4index_DistanceEdge_downstreamconcavecap_TRUE.at(ijkm)->Fill(Distance_TRUE_shift, wgt_minerva_v1);

                Hist_4index_Map_DistanceupstreamCap_downstreamconcavecap.at(ijkm)->Fill(dist_upstreamCap_shift, wgt_minerva_v1);
                Hist_4index_Map_DistancedownstreamCap_downstreamconcavecap.at(ijkm)->Fill(dist_downstreamCap_shift, wgt_minerva_v1);
                Hist_4index_Map_DistanceupstreamCap_downstreamconcavecap_TRUE.at(ijkm)->Fill(dist_upstreamCap_TRUE_shift, wgt_minerva_v1);
                Hist_4index_Map_DistancedownstreamCap_downstreamconcavecap_TRUE.at(ijkm)->Fill(dist_downstreamCap_TRUE_shift, wgt_minerva_v1);

                HistFolio_4index_Map_X_downstreamconcavecap.at(ijkm).GetComponentHist(Material_type_Event)->Fill(Vertex_X_OffSet, wgt_minerva_v1);
                HistFolio_4index_Map_Y_downstreamconcavecap.at(ijkm).GetComponentHist(Material_type_Event)->Fill(Vertex_Y_OffSet, wgt_minerva_v1);
                HistFolio_4index_Map_Z_downstreamconcavecap.at(ijkm).GetComponentHist(Material_type_Event)->Fill(Vertex_Z_OffSet, wgt_minerva_v1);
                HistFolio_4index_Map_R_downstreamconcavecap.at(ijkm).GetComponentHist(Material_type_Event)->Fill(Vertex_R_OffSet, wgt_minerva_v1);


                if(Cylindrical_CutAboutZero(Vertex_R_OffSet)== true){
                  Hist_4index_Map_DistanceupstreamCap_downstreamconcavecap_RCut.at(ijkm)->Fill(dist_upstreamCap_shift, wgt_minerva_v1);
                  Hist_4index_Map_DistancedownstreamCap_downstreamconcavecap_RCut.at(ijkm)->Fill(dist_downstreamCap_shift, wgt_minerva_v1);
                  Hist_4index_Map_DistanceupstreamCap_downstreamconcavecap_RCut_TRUE.at(ijkm)->Fill(dist_upstreamCap_TRUE_shift, wgt_minerva_v1);
                  Hist_4index_Map_DistancedownstreamCap_downstreamconcavecap_RCut_TRUE.at(ijkm)->Fill(dist_downstreamCap_TRUE_shift, wgt_minerva_v1);
                  Hist_4index_Map_Z_RCut_downstreamconcavecap_TRUE.at(ijkm)->Fill(Vertex_Z_OffSet_TRUE, wgt_minerva_v1);
                  Hist_4index_Map_Z_RCut_downstreamconcavecap.at(ijkm)->Fill(Vertex_Z_OffSet, wgt_minerva_v1);
...
if(m_RunCodeWithSystematics==true){sysmatics_status= "All_SysErrorsOn";}
  ...
  if(Run_EventLoopOnGid==true){
    sprintf(outFileName, "%s_%s_%s_%s_ConvolutionXY_noShift_noWgts.root", "Histograms",c,d,ErrorStatus);
    std::cout << "Writing output file on Grid to: " <<outFileName << std::endl;

  }
  else{
    sprintf(outFileName, "%s/%s_%s_%s_%s_ConvolutionXY_noShift_noWgts.root", rootpathway, "Histograms",c,d,ErrorStatus);
...
//  Index3 ijk{dog->first.i,dog->first.j,dog->first.k};
  ...
  Hist_4index_Map_Z.at(ijkm)->Write();
  Hist_4index_Map_Y.at(ijkm)->Write();
  Hist_4index_Map_X.at(ijkm)->Write();
  Hist_4index_Map_R.at(ijkm)->Write();
  Hist_4index_DistanceEdge.at(ijkm)->Write();
  Hist_4index_Map_Z_TRUE.at(ijkm)->Write();
  Hist_4index_Map_Z_RCut_TRUE.at(ijkm)->Write();
  Hist_4index_Map_Z_RCut.at(ijkm)->Write();
  Hist_4index_Map_Y_TRUE.at(ijkm)->Write();
  Hist_4index_Map_X_TRUE.at(ijkm)->Write();
  Hist_4index_Map_R_TRUE.at(ijkm)->Write();
  Hist_4index_DistanceEdge_TRUE.at(ijkm)->Write();


  Hist_4index_Map_X_upstreamCap.at(ijkm)->Write();
  Hist_4index_Map_Y_upstreamCap.at(ijkm)->Write();
  Hist_4index_Map_R_upstreamCap.at(ijkm)->Write();
  Hist_4index_Map_Z_upstreamCap.at(ijkm)->Write();
  Hist_4index_DistanceEdge_upstreamCap.at(ijkm)->Write();
  Hist_4index_Map_X_barrel.at(ijkm)->Write();
  Hist_4index_Map_Y_barrel.at(ijkm)->Write();
  Hist_4index_Map_R_barrel.at(ijkm)->Write();
  Hist_4index_Map_Z_barrel.at(ijkm)->Write();
  Hist_4index_DistanceEdge_barrel.at(ijkm)->Write();
  Hist_4index_Map_X_downstreamCap.at(ijkm)->Write();
  Hist_4index_Map_Y_downstreamCap.at(ijkm)->Write();
  Hist_4index_Map_R_downstreamCap.at(ijkm)->Write();
  Hist_4index_Map_Z_downstreamCap.at(ijkm)->Write();
  Hist_4index_DistanceEdge_downstreamCap.at(ijkm)->Write();
  Hist_4index_Map_X_downstreamconcavecap.at(ijkm)->Write();
  Hist_4index_Map_Y_downstreamconcavecap.at(ijkm)->Write();
  Hist_4index_Map_R_downstreamconcavecap.at(ijkm)->Write();
  Hist_4index_Map_Z_downstreamconcavecap.at(ijkm)->Write();
  Hist_4index_DistanceEdge_downstreamconcavecap.at(ijkm)->Write();

  Hist_4index_Map_X_upstreamCap_TRUE.at(ijkm)->Write();
  Hist_4index_Map_Y_upstreamCap_TRUE.at(ijkm)->Write();
  Hist_4index_Map_R_upstreamCap_TRUE.at(ijkm)->Write();
  Hist_4index_Map_Z_upstreamCap_TRUE.at(ijkm)->Write();
  Hist_4index_Map_Z_RCut_upstreamCap_TRUE.at(ijkm)->Write();
  Hist_4index_Map_Z_RCut_upstreamCap.at(ijkm)->Write();

  Hist_4index_DistanceEdge_upstreamCap_TRUE.at(ijkm)->Write();
  Hist_4index_Map_X_barrel_TRUE.at(ijkm)->Write();
  Hist_4index_Map_Y_barrel_TRUE.at(ijkm)->Write();
  Hist_4index_Map_R_barrel_TRUE.at(ijkm)->Write();
  Hist_4index_Map_Z_barrel_TRUE.at(ijkm)->Write();
  Hist_4index_Map_Z_RCut_barrel_TRUE.at(ijkm)->Write();
  Hist_4index_Map_Z_RCut_barrel.at(ijkm)->Write();

  Hist_4index_DistanceEdge_barrel_TRUE.at(ijkm)->Write();
  Hist_4index_Map_X_downstreamCap_TRUE.at(ijkm)->Write();
  Hist_4index_Map_Y_downstreamCap_TRUE.at(ijkm)->Write();
  Hist_4index_Map_R_downstreamCap_TRUE.at(ijkm)->Write();
  Hist_4index_Map_Z_downstreamCap_TRUE.at(ijkm)->Write();
  Hist_4index_Map_Z_RCut_downstreamCap_TRUE.at(ijkm)->Write();
  Hist_4index_Map_Z_RCut_downstreamCap.at(ijkm)->Write();
  Hist_4index_DistanceEdge_downstreamCap_TRUE.at(ijkm)->Write();
  Hist_4index_Map_X_downstreamconcavecap_TRUE.at(ijkm)->Write();
  Hist_4index_Map_Y_downstreamconcavecap_TRUE.at(ijkm)->Write();
  Hist_4index_Map_R_downstreamconcavecap_TRUE.at(ijkm)->Write();
  Hist_4index_Map_Z_downstreamconcavecap_TRUE.at(ijkm)->Write();
  Hist_4index_Map_Z_RCut_downstreamconcavecap_TRUE.at(ijkm)->Write();
  Hist_4index_Map_Z_RCut_downstreamconcavecap.at(ijkm)->Write();
  Hist_4index_DistanceEdge_downstreamconcavecap_TRUE.at(ijkm)->Write();


  Hist_4index_Map_DistanceupstreamCap_RCut.at(ijkm)->Write();
  Hist_4index_Map_DistancedownstreamCap_RCut.at(ijkm)->Write();
  Hist_4index_Map_DistanceupstreamCap_RCut_TRUE.at(ijkm)->Write();
  Hist_4index_Map_DistancedownstreamCap_RCut_TRUE.at(ijkm)->Write();
  Hist_4index_Map_DistanceupstreamCap_upstream_RCut.at(ijkm)->Write();
  Hist_4index_Map_DistancedownstreamCap_upstream_RCut.at(ijkm)->Write();
  Hist_4index_Map_DistanceupstreamCap_upstream_RCut_TRUE.at(ijkm)->Write();
  Hist_4index_Map_DistancedownstreamCap_upstream_RCut_TRUE.at(ijkm)->Write();
  Hist_4index_Map_DistanceupstreamCap_barrel_RCut.at(ijkm)->Write();
  Hist_4index_Map_DistancedownstreamCap_barrel_RCut.at(ijkm)->Write();
  Hist_4index_Map_DistanceupstreamCap_barrel_RCut_TRUE.at(ijkm)->Write();
  Hist_4index_Map_DistancedownstreamCap_barrel_RCut_TRUE.at(ijkm)->Write();
  Hist_4index_Map_DistanceupstreamCap_downstreamCap_RCut.at(ijkm)->Write();
  Hist_4index_Map_DistancedownstreamCap_downstreamCap_RCut.at(ijkm)->Write();
  Hist_4index_Map_DistanceupstreamCap_downstreamCap_RCut_TRUE.at(ijkm)->Write();
  Hist_4index_Map_DistancedownstreamCap_downstreamCap_RCut_TRUE.at(ijkm)->Write();
  Hist_4index_Map_DistanceupstreamCap_downstreamconcavecap_RCut.at(ijkm)->Write();
  Hist_4index_Map_DistancedownstreamCap_downstreamconcavecap_RCut.at(ijkm)->Write();
  Hist_4index_Map_DistanceupstreamCap_downstreamconcavecap_RCut_TRUE.at(ijkm)->Write();
  Hist_4index_Map_DistancedownstreamCap_downstreamconcavecap_RCut_TRUE.at(ijkm)->Write();
/// no RCut

  Hist_4index_Map_DistanceupstreamCap.at(ijkm)->Write();
  Hist_4index_Map_DistancedownstreamCap.at(ijkm)->Write();
  Hist_4index_Map_DistanceupstreamCap_TRUE.at(ijkm)->Write();
  Hist_4index_Map_DistancedownstreamCap_TRUE.at(ijkm)->Write();
  Hist_4index_Map_DistanceupstreamCap_upstream.at(ijkm)->Write();
  Hist_4index_Map_DistancedownstreamCap_upstream.at(ijkm)->Write();
  Hist_4index_Map_DistanceupstreamCap_upstream_TRUE.at(ijkm)->Write();
  Hist_4index_Map_DistancedownstreamCap_upstream_TRUE.at(ijkm)->Write();
  Hist_4index_Map_DistanceupstreamCap_barrel.at(ijkm)->Write();
  Hist_4index_Map_DistancedownstreamCap_barrel.at(ijkm)->Write();
  Hist_4index_Map_DistanceupstreamCap_barrel_TRUE.at(ijkm)->Write();
  Hist_4index_Map_DistancedownstreamCap_barrel_TRUE.at(ijkm)->Write();
  Hist_4index_Map_DistanceupstreamCap_downstreamCap.at(ijkm)->Write();
  Hist_4index_Map_DistancedownstreamCap_downstreamCap.at(ijkm)->Write();
  Hist_4index_Map_DistanceupstreamCap_downstreamCap_TRUE.at(ijkm)->Write();
  Hist_4index_Map_DistancedownstreamCap_downstreamCap_TRUE.at(ijkm)->Write();
  Hist_4index_Map_DistanceupstreamCap_downstreamconcavecap.at(ijkm)->Write();
  Hist_4index_Map_DistancedownstreamCap_downstreamconcavecap.at(ijkm)->Write();
  Hist_4index_Map_DistanceupstreamCap_downstreamconcavecap_TRUE.at(ijkm)->Write();
  Hist_4index_Map_DistancedownstreamCap_downstreamconcavecap_TRUE.at(ijkm)->Write();

  HistFolio_4index_Map_X_upstreamcap.at(ijkm).WriteToFile(*outFile);
  HistFolio_4index_Map_Y_upstreamcap.at(ijkm).WriteToFile(*outFile);
  HistFolio_4index_Map_Z_upstreamcap.at(ijkm).WriteToFile(*outFile);
  HistFolio_4index_Map_R_upstreamcap.at(ijkm).WriteToFile(*outFile);
  HistFolio_4index_Map_X_barrel.at(ijkm).WriteToFile(*outFile);
  HistFolio_4index_Map_Y_barrel.at(ijkm).WriteToFile(*outFile);
  HistFolio_4index_Map_Z_barrel.at(ijkm).WriteToFile(*outFile);
  HistFolio_4index_Map_R_barrel.at(ijkm).WriteToFile(*outFile);
  HistFolio_4index_Map_X_downstreamcap.at(ijkm).WriteToFile(*outFile);
  HistFolio_4index_Map_Y_downstreamcap.at(ijkm).WriteToFile(*outFile);
  HistFolio_4index_Map_Z_downstreamcap.at(ijkm).WriteToFile(*outFile);
  HistFolio_4index_Map_R_downstreamcap.at(ijkm).WriteToFile(*outFile);
  HistFolio_4index_Map_X_downstreamconcavecap.at(ijkm).WriteToFile(*outFile);
  HistFolio_4index_Map_Y_downstreamconcavecap.at(ijkm).WriteToFile(*outFile);
  HistFolio_4index_Map_Z_downstreamconcavecap.at(ijkm).WriteToFile(*outFile);
  HistFolio_4index_Map_R_downstreamconcavecap.at(ijkm).WriteToFile(*outFile);
...
for ( dog = OffSetMapZ_YOffSet_constantX.begin(); dog != OffSetMapZ_YOffSet_constantX.end();++dog)
{
  ...
  Hist_4index_Map_Z_Y_Z.at(ijkm)->Write();
  Hist_4index_Map_Z_Y_Y.at(ijkm)->Write();
  Hist_4index_Map_Z_Y_R.at(ijkm)->Write();
  Hist_4index_Map_Z_Y.at(ijkm)->Write();
  Hist_4index_Map_Z_Y_DistanceEdge.at(ijkm)->Write();
...
for ( dog = OffSetMapZ_XOffSet_constantY.begin(); dog != OffSetMapZ_XOffSet_constantY.end();++dog)
{
  ...
  Hist_4index_Map_Z_X_Z.at(ijkm)->Write();
  Hist_4index_Map_Z_X_X.at(ijkm)->Write();
  Hist_4index_Map_Z_X_R.at(ijkm)->Write();
  Hist_4index_Map_Z_X.at(ijkm)->Write();
  Hist_4index_Map_Z_X_DistanceEdge.at(ijkm)->Write();
...
for ( dog = OffSetMapZ_OffSet_constantXY.begin(); dog != OffSetMapZ_OffSet_constantXY.end();++dog)
{
  ...
  Hist_4index_Map_constantXY_ZOffSet.at(ijkm)->Write();
  Hist_4index_Map_constantXY_DistanceEdge.at(ijkm)->Write();
