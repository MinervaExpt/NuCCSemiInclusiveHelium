...
int NumZSteps = 120; //6; // steps of 2mm
...
//4.0, -4.0
//-24.0,-32
//AddZOffSettoSetMap(OffSetMapXYZ, -55.00, 10.00, NegZ_offset, PosZ_offset, NumZSteps, true );
...
//MnvH1D_3indexMap  Hist_3index_PT_downstreamconcavecap;
//MnvH1D_3indexMap  Hist_3index_PZ_downstreamconcavecap;
//MnvH1D_3indexMap  Hist_3index_muonE_downstreamconcavecap;
//MnvH1D_3indexMap  Hist_3index_muontheta_downstreamconcavecap;
//MnvH1D_3indexMap  Hist_3index_muonDoca_downstreamconcavecap;
//MnvH1D_3indexMap  Hist_3index_recoilDoca_downstreamconcavecap;
//MnvH1D_3indexMap  Hist_3index_Tracklength_downstreamconcavecap;
...
//HistFolio_material_type_3indexMap HistFolio_3index_PT_upstreamcap;
//HistFolio_material_type_3indexMap HistFolio_3index_PZ_upstreamcap;
//HistFolio_material_type_3indexMap HistFolio_3index_muontheta_upstreamcap;
//HistFolio_material_type_3indexMap HistFolio_3index_muonDoca_upstreamcap;
//HistFolio_material_type_3indexMap HistFolio_3index_recoilDoca_upstreamcap;
//HistFolio_material_type_3indexMap HistFolio_3index_Tracklength_upstreamcap;
...
//HistFolio_material_type_3indexMap HistFolio_3index_PT_barrel;
//HistFolio_material_type_3indexMap HistFolio_3index_PZ_barrel;
//HistFolio_material_type_3indexMap HistFolio_3index_muontheta_barrel;
//HistFolio_material_type_3indexMap HistFolio_3index_muonDoca_barrel;
//HistFolio_material_type_3indexMap HistFolio_3index_recoilDoca_barrel;
//HistFolio_material_type_3indexMap HistFolio_3index_Tracklength_barrel;
...
//HistFolio_material_type_3indexMap HistFolio_3index_PT_downstreamcap;
//HistFolio_material_type_3indexMap HistFolio_3index_PZ_downstreamcap;
//HistFolio_material_type_3indexMap HistFolio_3index_muontheta_downstreamcap;
//HistFolio_material_type_3indexMap HistFolio_3index_muonDoca_downstreamcap;
//HistFolio_material_type_3indexMap HistFolio_3index_recoilDoca_downstreamcap;
//HistFolio_material_type_3indexMap HistFolio_3index_Tracklength_downstreamcap;
...
//HistFolio_material_type_3indexMap HistFolio_3index_PT_downstreamconcavecap;
//HistFolio_material_type_3indexMap HistFolio_3index_PZ_downstreamconcavecap;
//HistFolio_material_type_3indexMap HistFolio_3index_muontheta_downstreamconcavecap;
//HistFolio_material_type_3indexMap HistFolio_3index_muonDoca_downstreamconcavecap;
//HistFolio_material_type_3indexMap HistFolio_3index_recoilDoca_downstreamconcavecap;
//HistFolio_material_type_3indexMap HistFolio_3index_Tracklength_downstreamconcavecap;
...
/*
    ...
    sprintf(tempName,"%s_i_j_k_%d_%d_%d","h_Map_PT_upstreamcap", i,j,k);
    PlotUtils::MnvH1D *hist_PT_upstreamcap = new PlotUtils::MnvH1D(tempName, tempName, PTbin_vector.size()-1,PTbin_vector.data());
    Hist_3index_PT_upstreamcap.insert(std::make_pair(ijk, hist_PT_upstreamcap ));

    sprintf(tempName,"%s_i_j_k_%d_%d_%d","h_Map_PZ_upstreamcap", i,j,k);
    PlotUtils::MnvH1D *hist_Pz_upstreamcap = new PlotUtils::MnvH1D(tempName, tempName, PZbin_vector.size()-1,PZbin_vector.data());
    Hist_3index_PZ_upstreamcap.insert(std::make_pair(ijk, hist_Pz_upstreamcap ));


    sprintf(tempName,"%s_i_j_k_%d_%d_%d","h_Map_muontheta_upstreamcap", i,j,k);
    PlotUtils::MnvH1D *hist_muontheta_upstreamcap = new PlotUtils::MnvH1D(tempName, tempName, MuonThetabin_vector.size()-1,MuonThetabin_vector.data());
    Hist_3index_muontheta_upstreamcap.insert(std::make_pair(ijk, hist_muontheta_upstreamcap ));


    sprintf(tempName,"%s_i_j_k_%d_%d_%d","h_Map_muonDoca_upstreamcap", i,j,k);
    PlotUtils::MnvH1D *hist_muondoca_upstreamcap = new PlotUtils::MnvH1D(tempName, tempName, Vertex_DOCAbin_vector.size()-1,Vertex_DOCAbin_vector.data());
    Hist_3index_muonDoca_upstreamcap.insert(std::make_pair(ijk, hist_muondoca_upstreamcap ));

    sprintf(tempName,"%s_i_j_k_%d_%d_%d","h_Map_muonE_upstreamcap", i,j,k);
    PlotUtils::MnvH1D *hist_muonE_upstreamcap = new PlotUtils::MnvH1D(tempName, tempName, Ebin_vector.size()-1,Ebin_vector.data());
    Hist_3index_muonE_upstreamcap.insert(std::make_pair(ijk, hist_muonE_upstreamcap ));

    sprintf(tempName,"%s_i_j_k_%d_%d_%d","h_Map_recoilDoca_upstreamcap", i,j,k);
    PlotUtils::MnvH1D *hist_recoildoca_upstreamcap = new PlotUtils::MnvH1D(tempName, tempName, secTrk_DOCA_vector.size()-1, secTrk_DOCA_vector.data());
    Hist_3index_recoilDoca_upstreamcap.insert(std::make_pair(ijk, hist_recoildoca_upstreamcap ));

    sprintf(tempName,"%s_i_j_k_%d_%d_%d","h_Map_Tracklength_upstreamcap", i,j,k);
    PlotUtils::MnvH1D *hist_tracklength_upstreamcap = new PlotUtils::MnvH1D(tempName, tempName, Recoil_track_length_vector.size()-1,Recoil_track_length_vector.data());
    Hist_3index_Tracklength_upstreamcap.insert(std::make_pair(ijk, hist_tracklength_upstreamcap ));
    */
    ...
    /*
    sprintf(tempName,"%s_i_j_k_%d_%d_%d","h_Map_PT_barrel", i,j,k);
    PlotUtils::MnvH1D *hist_PT_barrel = new PlotUtils::MnvH1D(tempName, tempName, PTbin_vector.size()-1,PTbin_vector.data());
    Hist_3index_PT_barrel.insert(std::make_pair(ijk, hist_PT_barrel ));

    sprintf(tempName,"%s_i_j_k_%d_%d_%d","h_Map_PZ_barrel", i,j,k);
    PlotUtils::MnvH1D *hist_Pz_barrel = new PlotUtils::MnvH1D(tempName, tempName, PZbin_vector.size()-1,PZbin_vector.data());
    Hist_3index_PZ_barrel.insert(std::make_pair(ijk, hist_Pz_barrel ));


    sprintf(tempName,"%s_i_j_k_%d_%d_%d","h_Map_muontheta_barrel", i,j,k);
    PlotUtils::MnvH1D *hist_muontheta_barrel = new PlotUtils::MnvH1D(tempName, tempName, MuonThetabin_vector.size()-1,MuonThetabin_vector.data());
    Hist_3index_muontheta_barrel.insert(std::make_pair(ijk, hist_muontheta_barrel ));

    /
    sprintf(tempName,"%s_i_j_k_%d_%d_%d","h_Map_muonDoca_barrel", i,j,k);
    PlotUtils::MnvH1D *hist_muondoca_barrel = new PlotUtils::MnvH1D(tempName, tempName, Vertex_DOCAbin_vector.size()-1,Vertex_DOCAbin_vector.data());
    Hist_3index_muonDoca_barrel.insert(std::make_pair(ijk, hist_muondoca_barrel ));

    sprintf(tempName,"%s_i_j_k_%d_%d_%d","h_Map_muonE_barrel", i,j,k);
    PlotUtils::MnvH1D *hist_muonE_barrel = new PlotUtils::MnvH1D(tempName, tempName, Ebin_vector.size()-1,Ebin_vector.data());
    Hist_3index_muonE_barrel.insert(std::make_pair(ijk, hist_muonE_barrel ));

    sprintf(tempName,"%s_i_j_k_%d_%d_%d","h_Map_recoilDoca_barrel", i,j,k);
    PlotUtils::MnvH1D *hist_recoildoca_barrel = new PlotUtils::MnvH1D(tempName, tempName, secTrk_DOCA_vector.size()-1, secTrk_DOCA_vector.data());
    Hist_3index_recoilDoca_barrel.insert(std::make_pair(ijk, hist_recoildoca_barrel ));

    sprintf(tempName,"%s_i_j_k_%d_%d_%d","h_Map_Tracklength_barrel", i,j,k);
    PlotUtils::MnvH1D *hist_tracklength_barrel = new PlotUtils::MnvH1D(tempName, tempName, Recoil_track_length_vector.size()-1,Recoil_track_length_vector.data());
    Hist_3index_Tracklength_barrel.insert(std::make_pair(ijk, hist_tracklength_barrel ));
    */
    ...
    /*
    sprintf(tempName,"%s_i_j_k_%d_%d_%d","h_Map_PT_downstreamcap", i,j,k);
    PlotUtils::MnvH1D *hist_PT_downstreamcap = new PlotUtils::MnvH1D(tempName, tempName, PTbin_vector.size()-1,PTbin_vector.data());
    Hist_3index_PT_downstreamcap.insert(std::make_pair(ijk, hist_PT_downstreamcap ));

    sprintf(tempName,"%s_i_j_k_%d_%d_%d","h_Map_PZ_downstreamcap", i,j,k);
    PlotUtils::MnvH1D *hist_Pz_downstreamcap = new PlotUtils::MnvH1D(tempName, tempName, PZbin_vector.size()-1,PZbin_vector.data());
    Hist_3index_PZ_downstreamcap.insert(std::make_pair(ijk, hist_Pz_downstreamcap ));


    sprintf(tempName,"%s_i_j_k_%d_%d_%d","h_Map_muontheta_downstreamcap", i,j,k);
    PlotUtils::MnvH1D *hist_muontheta_downstreamcap = new PlotUtils::MnvH1D(tempName, tempName, MuonThetabin_vector.size()-1,MuonThetabin_vector.data());
    Hist_3index_muontheta_downstreamcap.insert(std::make_pair(ijk, hist_muontheta_downstreamcap ));


    sprintf(tempName,"%s_i_j_k_%d_%d_%d","h_Map_muonDoca_downstreamcap", i,j,k);
    PlotUtils::MnvH1D *hist_muondoca_downstreamcap = new PlotUtils::MnvH1D(tempName, tempName, Vertex_DOCAbin_vector.size()-1,Vertex_DOCAbin_vector.data());
    Hist_3index_muonDoca_downstreamcap.insert(std::make_pair(ijk, hist_muondoca_downstreamcap ));

    sprintf(tempName,"%s_i_j_k_%d_%d_%d","h_Map_muonE_downstreamcap", i,j,k);
    PlotUtils::MnvH1D *hist_muonE_downstreamcap = new PlotUtils::MnvH1D(tempName, tempName, Ebin_vector.size()-1,Ebin_vector.data());
    Hist_3index_muonE_downstreamcap.insert(std::make_pair(ijk, hist_muonE_downstreamcap ));

    sprintf(tempName,"%s_i_j_k_%d_%d_%d","h_Map_recoilDoca_downstreamcap", i,j,k);
    PlotUtils::MnvH1D *hist_recoildoca_downstreamcap = new PlotUtils::MnvH1D(tempName, tempName, secTrk_DOCA_vector.size()-1, secTrk_DOCA_vector.data());
    Hist_3index_recoilDoca_downstreamcap.insert(std::make_pair(ijk, hist_recoildoca_downstreamcap ));

    sprintf(tempName,"%s_i_j_k_%d_%d_%d","h_Map_Tracklength_downstreamcap", i,j,k);
    PlotUtils::MnvH1D *hist_tracklength_downstreamcap = new PlotUtils::MnvH1D(tempName, tempName, Recoil_track_length_vector.size()-1,Recoil_track_length_vector.data());
    Hist_3index_Tracklength_downstreamcap.insert(std::make_pair(ijk, hist_tracklength_downstreamcap ));
    */
    ...
    /*
    sprintf(tempName,"%s_i_j_k_%d_%d_%d","h_Map_PT_downstreamconcavecap", i,j,k);
    PlotUtils::MnvH1D *hist_PT_downstreamconcavecap = new PlotUtils::MnvH1D(tempName, tempName, PTbin_vector.size()-1,PTbin_vector.data());
    Hist_3index_PT_downstreamconcavecap.insert(std::make_pair(ijk, hist_PT_downstreamconcavecap ));

    sprintf(tempName,"%s_i_j_k_%d_%d_%d","h_Map_PZ_downstreamconcavecap", i,j,k);
    PlotUtils::MnvH1D *hist_Pz_downstreamconcavecap = new PlotUtils::MnvH1D(tempName, tempName, PZbin_vector.size()-1,PZbin_vector.data());
    Hist_3index_PZ_downstreamconcavecap.insert(std::make_pair(ijk, hist_Pz_downstreamconcavecap ));


    sprintf(tempName,"%s_i_j_k_%d_%d_%d","h_Map_muontheta_downstreamconcavecap", i,j,k);
    PlotUtils::MnvH1D *hist_muontheta_downstreamconcavecap = new PlotUtils::MnvH1D(tempName, tempName, MuonThetabin_vector.size()-1,MuonThetabin_vector.data());
    Hist_3index_muontheta_downstreamconcavecap.insert(std::make_pair(ijk, hist_muontheta_downstreamconcavecap ));


    sprintf(tempName,"%s_i_j_k_%d_%d_%d","h_Map_muonDoca_downstreamconcavecap", i,j,k);
    PlotUtils::MnvH1D *hist_muondoca_downstreamconcavecap = new PlotUtils::MnvH1D(tempName, tempName, Vertex_DOCAbin_vector.size()-1,Vertex_DOCAbin_vector.data());
    Hist_3index_muonDoca_downstreamconcavecap.insert(std::make_pair(ijk, hist_muondoca_downstreamconcavecap ));

    sprintf(tempName,"%s_i_j_k_%d_%d_%d","h_Map_muonE_downstreamconcavecap", i,j,k);
    PlotUtils::MnvH1D *hist_muonE_downstreamconcavecap = new PlotUtils::MnvH1D(tempName, tempName, Ebin_vector.size()-1,Ebin_vector.data());
    Hist_3index_muonE_downstreamconcavecap.insert(std::make_pair(ijk, hist_muonE_downstreamconcavecap ));

    sprintf(tempName,"%s_i_j_k_%d_%d_%d","h_Map_recoilDoca_downstreamconcavecap", i,j,k);
    PlotUtils::MnvH1D *hist_recoildoca_downstreamconcavecap = new PlotUtils::MnvH1D(tempName, tempName, secTrk_DOCA_vector.size()-1, secTrk_DOCA_vector.data());
    Hist_3index_recoilDoca_downstreamconcavecap.insert(std::make_pair(ijk, hist_recoildoca_downstreamconcavecap ));

    sprintf(tempName,"%s_i_j_k_%d_%d_%d","h_Map_Tracklength_downstreamconcavecap", i,j,k);
    PlotUtils::MnvH1D *hist_tracklength_downstreamconcavecap = new PlotUtils::MnvH1D(tempName, tempName, Recoil_track_length_vector.size()-1,Recoil_track_length_vector.data());
    Hist_3index_Tracklength_downstreamconcavecap.insert(std::make_pair(ijk, hist_tracklength_downstreamconcavecap ));
    */
        ...
        for (auto universe : Universe_GROUP){
          ...
          if(isCV(*universe)){
            ...
            int mapcount_loop =0;
                ...
                double Vertex_R_OffSet_TRUE = sqrt(pow(Vertex_X_OffSet_TRUE,2) + pow(Vertex_Y_OffSet_TRUE,2) );
...
//                std::cout<<" index = " << mapcount_loop << " key (i,j,k) =  (" << dog->first.i <<" , "<< dog->first.j<< " , "<< dog->first.k  <<")   OffSet (x, y, z) =  (" << dog->second.x << ", " << dog->second.y<< " , "<< dog->second.z <<" ) "<<std::endl;
                  ...
                  if(CryoTankRegion_type==kUpstream_head)
                  {
                    ...
                    Hist_3index_DistanceEdge_upstreamcap.at(ijk)->Fill(Distance, wgt_minerva_v1);
                  ...
                  else if(CryoTankRegion_type==kCenter)
                  {
                    ...
                    Hist_3index_DistanceEdge_barrel.at(ijk)->Fill(Distance, wgt_minerva_v1);
                  ...
                  else if(CryoTankRegion_type==kDownstream_head)
                  {
                    ...
                    Hist_3index_DistanceEdge_downstreamcap.at(ijk)->Fill(Distance, wgt_minerva_v1);
                  ...
                  else if(CryoTankRegion_type==kDownstream_ConcaveCap)
                  {
                    ...
                    Hist_3index_DistanceEdge_downstreamconcavecap.at(ijk)->Fill(Distance, wgt_minerva_v1);
...
if(m_RunCodeWithSystematics==true){sysmatics_status= "All_SysErrorsOn";}
  ...
  if(Run_EventLoopOnGid==true){
    sprintf(outFileName, "%s_%s_%s_%s_OFFSET_ConvolutionXY_ZShift%s.root", "Histograms",c,d,ErrorStatus, Wgts_char);
    std::cout << "Writing output file on Grid to: " <<outFileName << std::endl;

  }
  else{
    sprintf(outFileName, "%s/%s_%s_%s_%s_OFFSET_ConvolutionXY_ZShift%s.root", rootpathway, "Histograms",c,d,ErrorStatus, Wgts_char);
