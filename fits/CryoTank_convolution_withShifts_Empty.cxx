...
sprintf(text_title_pdf1, "Plots_Convolution_shifts_Z_Empty.pdf(" );
can -> Print(text_title_pdf1);
sprintf(text_title_pdf2, "Plots_Convolution_shifts_Z_Empty.pdf" );
sprintf(text_title_pdf3, "Plots_Convolution_shifts_Z_Empty.pdf)" );
sprintf(text_title_pdf4, "Plots_Convolution_shifts_Z_Empty" );
std::string PDF_label(text_title_pdf4);
std::string PDF_label_input(text_title_pdf2);

sprintf(chisqrt_title_pdf1, "Plots_Convolution_shifts_ChiSqrt_Fullsearch_ZEMPTY.pdf(" );
can -> Print(chisqrt_title_pdf1);
sprintf(chisqrt_title_pdf2, "Plots_Convolution_shifts_ChiSqrt_Fullsearch_ZEMPTY.pdf" );
sprintf(chisqrt_title_pdf3, "Plots_Convolution_shifts_ChiSqrt_Fullsearch_ZEMPTY.pdf)" );
sprintf(chisqrt_title_pdf4, "Plots_Convolution_shifts_ChiSqrt_Fullsearch_ZEMPTY" );
...
//double Chisqrt_Top1 =3278.88;
//double Chisqrt_Top2 =3279.27;
//double Chisqrt_Top3 =3293.18;
//double Chisqrt_Top4 =3301.3;
//double Chisqrt_Top5 =3302.98;
//double Chisqrt_Top6 =3305.38;
...
//Index3 Top1index{15, 1 , 0 };
//Index3 Top2index{15, 2 , 0 };
//Index3 Top3index{15, 0 , 0 };
//Index3 Top4index{14, 2 , 0 };
//Index3 Top5index{14, 1 , 0 };
//Index3 Top6index{14, 0 , 0 };



//double Chisqrt_Top1 = 3293.18;
//double Chisqrt_Top2 = 3305.38;
//double Chisqrt_Top3 = 3309.08;
//double Chisqrt_Top4 = 3309.72;
//double Chisqrt_Top5 = 99999;
//Index3 Top1index{30, 0 , 0 };
//Index3 Top2index{29, 0 , 0};
//Index3 Top3index{28, 0 , 0 };
//Index3 Top4index{29, 1 , 0};

//rank =1 ChiSqt = 3426.11index (i,j,k) = (13, 0 , 0 )
//rank =2 ChiSqt = 3429.63index (i,j,k) = (12, 1 , 0 )
//rank =3 ChiSqt = 3434.61index (i,j,k) = (11, 0 , 0 )
//rank =4 ChiSqt = 3437.6index (i,j,k) = (12, 0 , 0 )
//rank =5 ChiSqt = 3438.43index (i,j,k) = (12, 2 , 0 )
//rank =6 ChiSqt = 3440.03index (i,j,k) = (13, 1 , 0 )
...
Fill_Convolution_BeforeShift(kME1C ,vertex_X_mean,
    ...
    Convolution_Tool_TotalPlaylist.FillEmpty_Normal_Fit_ParametersXY(vertex_X_mean,vertex_X_sigma, vertex_Y_mean, vertex_Y_sigma);
...
Convolution_Tool_TotalPlaylist.initEMPTYONLY_RECO_Convolution_Material_Regions_Hists_PlaylistCombinedMC( ZeroShift.i,  ZeroShift.j,  ZeroShift.k );
std::cout<<"~~~~~~~~~~~~~Staring to Intialize TRUE Material Plots~~~~~~~~~~~~~~~~~~~~~"<<std::endl;
Convolution_Tool_TotalPlaylist.initEMPTYONLY_RECO_Convolution_Material_Regions_TRUEHists_PlaylistCombinedMC(ZeroShift.i,  ZeroShift.j,  ZeroShift.k);
std::cout<<"~~~~~~~~~~~~~Staring to Intialize non fit  Material Plots~~~~~~~~~~~~~~~~~~~~~"<<std::endl;
Convolution_Tool_TotalPlaylist.initEMPTYONLY_RECO_Convolution_Material_Regions_NON_vertex_varsHists_PlaylistCombinedMC(ZeroShift.i,  ZeroShift.j,  ZeroShift.k);
std::cout<<"~~~~~~~~~~~~~ to Intialize TRUE Material Plots~~~~~~~~~~~~~~~~~~~~~"<<std::endl;

Convolution_Tool_TotalPlaylist.Plot_regions_XYZFit_Empty( 0 , 0, 0, 0, "Before Fit" );
Convolution_Tool_TotalPlaylist.Plot_regions_TRUEXYZFit_Empty(0 , 0, 0, 0, "Before Fit" );
Convolution_Tool_TotalPlaylist.Plot_regions_NonFitVars_Empty( 0 , 0, 0, 0, "Before Fit"  );
...
Convolution_Tool_TotalPlaylist.ApplyFitResults_toTRUEEmpty();
Convolution_Tool_TotalPlaylist.ApplyFitResults_tononFitVarEmpty();
Convolution_Tool_TotalPlaylist.CalMaterial_ChiSqrtEmptyAfter( ChisqrtX, ChisqrtY, ChisqrtZ, ChisqrtR);
Convolution_Tool_TotalPlaylist.Plot_regions_XYZFit_Empty( 0 , 0, 1, 1, "After Fit" );
Convolution_Tool_TotalPlaylist.Plot_regions_TRUEXYZFit_Empty(0 , 0, 1, 1, "After Fit" );
Convolution_Tool_TotalPlaylist.Plot_regions_NonFitVars_Empty( 0 , 0, 1, 1, "After Fit"  );
...
double ZeroshiftChit = ChisqrtX + ChisqrtY + ChisqrtZ;
...
Convolution_Tool_TotalPlaylist.initEMPTYONLY_RECO_Convolution_Material_Regions_Hists_PlaylistCombinedMC( dog->first.i,  dog->first.j,  dog->first.k );
...
std::cout<<"Printing out top Chisq"<< std::endl;
...
sprintf(outputFileName,"/minerva/data/users/cnguyen/Convolution_vertexRootfiles/Convolution_Empty_bd1_%.2f_bd2_%.2f_bd3_%.2f.root",boundary1, boundary2, boundary3 );
std::cout<<"Making file:" << outputFileName << std::endl;

// add zero shift to root file

Chisqrt_Top5Map.insert(std::pair<double , Index3 >(9999, ZeroShift));
...
Convolution_Tool_TotalPlaylist.initEMPTYONLY_RECO_Convolution_Material_Regions_Hists_PlaylistCombinedMC(MapIndex.second.i, MapIndex.second.j, MapIndex.second.k );
...
Convolution_Tool_TotalPlaylist.Plot_regions_XYZFit_Empty( mean  , stddev, 0, 0, "before");

std::cout<<"~~~~~~~~~~~~~Staring to Intialize TRUE Material Plots~~~~~~~~~~~~~~~~~~~~~"<<std::endl;
Convolution_Tool_TotalPlaylist.initEMPTYONLY_RECO_Convolution_Material_Regions_TRUEHists_PlaylistCombinedMC(MapIndex.second.i,  MapIndex.second.j,  MapIndex.second.k);
std::cout<<"~~~~~~~~~~~~~Staring to Intialize non fit  Material Plots~~~~~~~~~~~~~~~~~~~~~"<<std::endl;
Convolution_Tool_TotalPlaylist.initEMPTYONLY_RECO_Convolution_Material_Regions_NON_vertex_varsHists_PlaylistCombinedMC(MapIndex.second.i,  MapIndex.second.j,  MapIndex.second.k);
std::cout<<"~~~~~~~~~~~~~ to Intialize TRUE Material Plots~~~~~~~~~~~~~~~~~~~~~"<<std::endl;
...
Convolution_Tool_TotalPlaylist.initEMPTYONLY_RECO_Convolution_Material_Regions_Hists_PlaylistCombinedMC_Fiducial(MapIndex.second.i, MapIndex.second.j, MapIndex.second.k );
std::cout<<"~~~~~~~~~~~~~Staring to Intialize TRUE Material Fiducial Hists~~~~~~~~~~~~~~~~~~~~~"<<std::endl;
Convolution_Tool_TotalPlaylist.initEMPTYONLY_RECO_Convolution_Material_Regions_TRUEHists_PlaylistCombinedMC_Fiducial(MapIndex.second.i,  MapIndex.second.j,  MapIndex.second.k);
std::cout<<"~~~~~~~~~~~~~Staring to Intialize non fit  Material Fiducial Plots~~~~~~~~~~~~~~~~~~~~~"<<std::endl;
Convolution_Tool_TotalPlaylist.initEMPTYONLY_RECO_Convolution_Material_Regions_NON_vertex_varsHists_PlaylistCombinedMC_Fiducial(MapIndex.second.i,  MapIndex.second.j,  MapIndex.second.k);
std::cout<<"~~~~~~~~~~~~~ to Intialize TRUE Material Fiducial Plots~~~~~~~~~~~~~~~~~~~~~"<<std::endl;


Convolution_Tool_TotalPlaylist.Plot_regions_TRUEXYZFit_Empty_Fiducial(0 , 0, 0, 0, "Before Fit [Fiducial]" );
Convolution_Tool_TotalPlaylist.Plot_regions_NonFitVars_Empty_Fiducial( 0 , 0, 0, 0, "Before Fit [Fiducial]"  );
Convolution_Tool_TotalPlaylist.Plot_regions_XYZFit_Empty_Fiducial( mean  , stddev, 0, 0, "before [Fiducial]");
...
Convolution_Tool_TotalPlaylist.ApplyFitResults_toEmpty_Fiducial();
Convolution_Tool_TotalPlaylist.ApplyFitResults_toTRUEEmpty_Fiducial();
Convolution_Tool_TotalPlaylist.ApplyFitResults_tononFitVarEmpty_Fiducial();

Convolution_Tool_TotalPlaylist.CalMaterial_ChiSqrtEmptyAfter( ChisqrtX, ChisqrtY, ChisqrtZ, ChisqrtR);
double Chisqrt =  ChisqrtX + ChisqrtY + ChisqrtZ;

sprintf(name,"Empty_rank_%d_i_j_k_%d_%d_%d",topones, MapIndex.second.i, MapIndex.second.j, MapIndex.second.k);
sprintf(name_Fid , "Empty_rank_%d_i_j_k_%d_%d_%d_Fiducial", topones, MapIndex.second.i, MapIndex.second.j, MapIndex.second.k);
sprintf(Plot_title,  "Fit #chi^{2} =  %.1f", Chisqrt  );
std::string PLOT_string(Plot_title);
Convolution_Tool_TotalPlaylist.Plot_regions_XYZFit_Empty( mean  , stddev, 1, 1, PLOT_string);
Convolution_Tool_TotalPlaylist.Plot_regions_TRUEXYZFit_Empty(0 , 0, 1, 1, PLOT_string );
Convolution_Tool_TotalPlaylist.Plot_regions_NonFitVars_Empty( 0 , 0, 1, 1, PLOT_string  );
std::cout<<"Trying to write files with starting name = "<< name <<std::endl;


Convolution_Tool_TotalPlaylist.Plot_regions_XYZFit_Empty_Fiducial( mean  , stddev, 1, 1, PLOT_string);
Convolution_Tool_TotalPlaylist.Plot_regions_TRUEXYZFit_Empty_Fiducial(0 , 0, 1, 1, PLOT_string );
Convolution_Tool_TotalPlaylist.Plot_regions_NonFitVars_Empty_Fiducial( 0 , 0, 1, 1, PLOT_string  );


Convolution_Tool_TotalPlaylist.Write_Empty_init_and_wgted(*outFile,  name);
Convolution_Tool_TotalPlaylist.Write_Empty_init_and_wgted_Fiducial(*outFile,  name_Fid);
