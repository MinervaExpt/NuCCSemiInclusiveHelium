...
///////////////////////////////////////////
// Convolution shifts + ReWeighting
//
//
///////////////////////////////////////////
...
sprintf(text_title_pdf1, "Plots_Events_Convolution_shifts_WithReWgts_Log_FULL.pdf(" );
can -> Print(text_title_pdf1);
sprintf(text_title_pdf2, "Plots_Events_Convolution_shifts_WithReWgts_Log_FULL.pdf" );
sprintf(text_title_pdf3, "Plots_Events_Convolution_shifts_WithReWgts_Log_FULL.pdf)" );
sprintf(text_title_pdf4, "Plots_Events_Convolution_shifts_WithReWgts_Log_FULL" );
std::string PDF_label(text_title_pdf4);
std::string PDF_label_input(text_title_pdf2);

sprintf(chisqrt_title_pdf1, "Plots_ConvolutionShifts_withReWgts_ChiSqrt_Log_FULL.pdf(" );
can -> Print(chisqrt_title_pdf1);
sprintf(chisqrt_title_pdf2, "Plots_ConvolutionShifts_withReWgts_ChiSqrt_Log_FULL.pdf" );
sprintf(chisqrt_title_pdf3, "Plots_ConvolutionShifts_withReWgts_ChiSqrt_Log_FULL.pdf)" );
sprintf(chisqrt_title_pdf4, "Plots_ConvolutionShifts_withReWgts_ChiSqrt_Log_FULL" );
...
auto PlaylistME_1G_MC_path = "/minerva/data/users/cnguyen/ME_MC_EventSection_RootFiles/Histograms_minervame1G_MC_StatsONLYErrors_Convolution_noShift_noWgts.root";
auto PlaylistME_1A_MC_path = "/minerva/data/users/cnguyen/ME_MC_EventSection_RootFiles/Histograms_minervame1A_MC_StatsONLYErrors_Convolution_noShift_noWgts.root";
auto PlaylistME_1L_MC_path = "/minerva/data/users/cnguyen/ME_MC_EventSection_RootFiles/Histograms_minervame1L_MC_StatsONLYErrors_Convolution_noShift_noWgts.root";
auto PlaylistME_1M_MC_path = "/minerva/data/users/cnguyen/ME_MC_EventSection_RootFiles/Histograms_minervame1M_MC_StatsONLYErrors_Convolution_noShift_noWgts.root";
auto PlaylistME_1N_MC_path = "/minerva/data/users/cnguyen/ME_MC_EventSection_RootFiles/Histograms_minervame1N_MC_StatsONLYErrors_Convolution_noShift_noWgts.root";
...
auto PlaylistME_1P_MC_path = "/minerva/data/users/cnguyen/ME_MC_EventSection_RootFiles/Histograms_minervame1P_MC_StatsONLYErrors_Convolution_noShift_noWgts.root";
auto PlaylistME_1C_MC_path = "/minerva/data/users/cnguyen/ME_MC_EventSection_RootFiles/Histograms_minervame1C_MC_StatsONLYErrors_Convolution_noShift_noWgts.root";
auto PlaylistME_1D_MC_path = "/minerva/data/users/cnguyen/ME_MC_EventSection_RootFiles/Histograms_minervame1D_MC_StatsONLYErrors_Convolution_noShift_noWgts.root";
auto PlaylistME_1F_MC_path = "/minerva/data/users/cnguyen/ME_MC_EventSection_RootFiles/Histograms_minervame1F_MC_StatsONLYErrors_Convolution_noShift_noWgts.root";
auto PlaylistME_1E_MC_path = "/minerva/data/users/cnguyen/ME_MC_EventSection_RootFiles/Histograms_minervame1E_MC_StatsONLYErrors_Convolution_noShift_noWgts.root";
...
double stddev_offset_Finish_vertexZ = 160.0; //48.0;
int stddev_steps = 20;
double mean_offset_Start_vertexZ = -100; //30.0;
double mean_offset_Finish_vertexZ = 100.0; //48.0;
int mean_steps = 25; // reduced my half
...
Index3 ZeroShift{0,0,1}; // Zero Shift for Convolution
...
MnvH2D *h_Chisqrt_X_RECO_todata_Empty[N_Hists];  // 0 total 1 upstream cap , 2 barrel , 3 downstream, 4 downstreamconcave
MnvH2D *h_Chisqrt_Y_RECO_todata_Empty[N_Hists];
MnvH2D *h_Chisqrt_Z_RECO_todata_Empty[N_Hists];
MnvH2D *h_Chisqrt_R_RECO_todata_Empty[N_Hists];
MnvH2D *h_Chisqrt_Combined_RECO_todata_Empty[N_Hists];

Array2D(h_Chisqrt_X_RECO_todata_Empty,      N_Hists, "h_Chisqrt_X_RECO_todata_Empty",      "h_Chisqrt_X_todata",mean_offsetVector, stddev_offsetVector);
Array2D(h_Chisqrt_Y_RECO_todata_Empty,      N_Hists, "h_Chisqrt_Y_RECO_todata_Empty",      "h_Chisqrt_Y_todata",mean_offsetVector, stddev_offsetVector);
Array2D(h_Chisqrt_Z_RECO_todata_Empty,      N_Hists, "h_Chisqrt_Z_RECO_todata_Empty",      "h_Chisqrt_Z_todata",mean_offsetVector, stddev_offsetVector);
Array2D(h_Chisqrt_R_RECO_todata_Empty,      N_Hists, "h_Chisqrt_R_RECO_todata_Empty",      "h_Chisqrt_R_todata",mean_offsetVector, stddev_offsetVector);
Array2D(h_Chisqrt_Combined_RECO_todata_Empty,      N_Hists, "h_Chisqrt_Combined_RECO_todata_Empty",      "h_Chisqrt_Combined_RECO_todata_Empty",mean_offsetVector, stddev_offsetVector);
...
double LeastChisqt_X_after = 999999;
double LeastChisqt_Y_after = 999999;
double LeastChisqt_Z_after = 999999;
double LeastChisqt_R_after = 999999;
double LeastChisqt_Combined_after = 999999;

Index3 least_Xafter{99,99,99};
Index3 least_Yafter{99,99,99};
Index3 least_Zafter{99,99,99};
Index3 least_Rafter{99,99,99};
Index3 least_Combinedafter{99,99,99};


Convolution_Tool_TotalPlaylist.Fill_Regions_bestindex3_default(BestIndex_Regions_Full);
Convolution_Tool_TotalPlaylist.Fill_Regions_bestindex3_default(BestIndex_Regions_Empty);
Convolution_Tool_TotalPlaylist.Fill_Regions_bestindex3_default(BestIndex_Regions_Full_Empty);


Convolution_Tool_TotalPlaylist.Fill_Regions_ChiSqrt_results_default(ChiSqrt_CryoTankRegions_Full);
Convolution_Tool_TotalPlaylist.Fill_Regions_ChiSqrt_results_default(ChiSqrt_CryoTankRegions_Empty);
Convolution_Tool_TotalPlaylist.Fill_Regions_ChiSqrt_results_default(ChiSqrt_CryoTankRegions_Full_Empty);

Convolution_Tool_TotalPlaylist.Fill_Regions_ChiSqrt_results_default(BEST_ChiSqrt_CryoTankRegions_Full);
Convolution_Tool_TotalPlaylist.Fill_Regions_ChiSqrt_results_default(BEST_ChiSqrt_CryoTankRegions_Empty);
Convolution_Tool_TotalPlaylist.Fill_Regions_ChiSqrt_results_default(BEST_ChiSqrt_CryoTankRegions_Full_Empty);
...
std::cout<<"Assiging names to "<<std::endl;
...
Convolution_Tool_TotalPlaylist.Plot_init_material_Full("no wgts [noShift][noConvolution][Full]");

SetConvolutionShiftMapTool(Convolution_Tool_TotalPlaylist);
std::vector<double> wgt_vector;
 std::vector<double> wgt_error_vector;
double chisqrt_x = 999999;
double chisqrt_y = 99999;
double chisqrt_z=99999;
double chisqrt_r=99999;
...
FitConvolutionTool(Convolution_Tool_TotalPlaylist, 4,
  "Convolution", "file1", PDF_label, wgt_vector, wgt_error_vector);
...
Convolution_Tool_TotalPlaylist.CalMaterial_ChiSqrtFullAfter( chisqrt_x, chisqrt_y, chisqrt_z, chisqrt_r);

Index3 input_index{dog->first.i, dog->first.j, dog->first.k};
double CombinedChi = chisqrt_x + chisqrt_y + chisqrt_z;


h_Chisqrt_X_RECO_todata_Empty[0]->Fill(mean, stddev, chisqrt_x );
h_Chisqrt_Y_RECO_todata_Empty[0]->Fill(mean, stddev, chisqrt_y );
h_Chisqrt_Z_RECO_todata_Empty[0]->Fill(mean, stddev, chisqrt_z );
h_Chisqrt_R_RECO_todata_Empty[0]->Fill(mean, stddev, chisqrt_r );
h_Chisqrt_Combined_RECO_todata_Empty[0]->Fill(mean, stddev, CombinedChi);


if (LeastChisqt_X_after > chisqrt_x) {
  LeastChisqt_X_after = chisqrt_x;
  least_Xafter = dog->first;
}

if (LeastChisqt_Y_after > chisqrt_y) {
  LeastChisqt_Y_after = chisqrt_y;
  least_Yafter = dog->first;
}

if (LeastChisqt_Z_after > chisqrt_z) {
  LeastChisqt_Z_after = chisqrt_z;
  least_Zafter = dog->first;
}

if (LeastChisqt_R_after > chisqrt_r ) {
  LeastChisqt_R_after = chisqrt_r;
  least_Rafter = dog->first;
}

if (LeastChisqt_Combined_after > CombinedChi) {
  LeastChisqt_Combined_after = CombinedChi;
  least_Combinedafter = dog->first;
}
...
sprintf(Plot_title, "F[All][noFid] Vertex X Min(#mu, #sigma) = (%.2f, %.2f) = %.2f [Log #chi_{X}^{2}]",
  ZShifts[least_Xafter].mean, ZShifts[least_Xafter].stddev, LeastChisqt_X_after);

Draw2DHist(h_Chisqrt_X_RECO_todata_Empty[0], "mean (#mu)", "stddev (#sigma)", "X Vertex #chi^2 ",Plot_title, chisqrt_title_pdf2, can, mnv_plot);

sprintf(Plot_title, "F[All][noFid] Vertex Y Min(#mu, #sigma) = (%.2f, %.2f) = %.2f [Log #chi_{Y}^{2}]",
  ZShifts[least_Yafter].mean, ZShifts[least_Yafter].stddev, LeastChisqt_Y_after);
Draw2DHist(h_Chisqrt_Y_RECO_todata_Empty[0],  "mean (#mu)", "stddev (#sigma)", "Y Vertex #chi^2 ",Plot_title, chisqrt_title_pdf2, can, mnv_plot);

sprintf(Plot_title, "F[All][noFid] Vertex Z Min(#mu, #sigma) = (%.2f, %.2f) = %.2f [Log #chi_{Z}^{2}]",
  ZShifts[least_Zafter].mean, ZShifts[least_Zafter].stddev, LeastChisqt_Z_after);

Draw2DHist(h_Chisqrt_Z_RECO_todata_Empty[0],  "mean (#mu)", "stddev (#sigma)", "#chi^2 ", Plot_title,chisqrt_title_pdf2, can, mnv_plot);

  sprintf(Plot_title, "F[All][noFid] Vertex R Min(#mu, #sigma) = (%.2f, %.2f) = %.2f [Log #chi_{R}^{2}]",
    ZShifts[least_Rafter].mean, ZShifts[least_Rafter].stddev, LeastChisqt_R_after);

Draw2DHist(h_Chisqrt_R_RECO_todata_Empty[0],  "mean (#mu)", "stddev (#sigma)", "Log #chi_{R}^2",Plot_title, chisqrt_title_pdf2, can, mnv_plot);

sprintf(Plot_title, "F[All][noFid] Combined Min(#mu, #sigma) = (%.2f, %.2f) = %.2f [Log #chi_{X+Y+Z}^{2}]",
  ZShifts[least_Combinedafter].mean, ZShifts[least_Combinedafter].stddev, LeastChisqt_Combined_after);

Draw2DHist(h_Chisqrt_Combined_RECO_todata_Empty[0],  "mean (#mu)", "stddev (#sigma)", "Combined #chi^2 ", Plot_title, chisqrt_title_pdf2, can, mnv_plot);
...
Convolution_Tool_TotalPlaylist.initFULLONLY_RECO_Convolution_Material_Regions_Hists_PlaylistCombinedMC(least_Xafter.i, least_Xafter.j, least_Xafter.k);
//std::cout<<"Cal_Chisqt_Total"<<std::endl;
...
stream << std::fixed << std::setprecision(1) << ZShifts[least_Xafter].mean;
std::string mean_string = stream.str();
stream.str(std::string());
stream << std::fixed << std::setprecision(1) << ZShifts[least_Xafter].stddev;
std::string stddev_string = stream.str();
stream.str(std::string());
stream << std::fixed << std::setprecision(1) << LeastChisqt_X_after;
std::string chisqrt_string = stream.str();
stream.str(std::string());
std::string PlotTitle = " Min(#sigma,#mu) = (" + stddev_string +  ", " + mean_string +" ) =  [Log #chi_{X}^{2}] = " + chisqrt_string;
Convolution_Tool_TotalPlaylist.Plot_AfterFit_material_Full(PlotTitle);
wgt_vector.clear();
wgt_error_vector.clear();
Convolution_Tool_TotalPlaylist.Clear_Al_wgt();
////////////////////////////////////////////////////////////
Convolution_Tool_TotalPlaylist.initFULLONLY_RECO_Convolution_Material_Regions_Hists_PlaylistCombinedMC(least_Yafter.i, least_Yafter.j, least_Yafter.k);
//std::cout<<"Cal_Chisqt_Total"<<std::endl;
...
stream << std::fixed << std::setprecision(1) << ZShifts[least_Yafter].mean;
 mean_string = stream.str();
stream.str(std::string());
stream << std::fixed << std::setprecision(1) << ZShifts[least_Yafter].stddev;
 stddev_string = stream.str();
 stream.str(std::string());
 stream << std::fixed << std::setprecision(1) << LeastChisqt_Y_after;
 chisqrt_string = stream.str();
 stream.str(std::string());
 PlotTitle = " Min(#sigma,#mu) = (" + stddev_string +  ", " + mean_string +" ) =  [Log #chi_{Y}^{2}] = " + chisqrt_string;
Convolution_Tool_TotalPlaylist.Plot_AfterFit_material_Full(PlotTitle);
wgt_vector.clear();
wgt_error_vector.clear();
Convolution_Tool_TotalPlaylist.Clear_Al_wgt();
...
////////////////////////////////////////////////////////////
Convolution_Tool_TotalPlaylist.initFULLONLY_RECO_Convolution_Material_Regions_Hists_PlaylistCombinedMC(least_Zafter.i, least_Zafter.j, least_Zafter.k);
//std::cout<<"Cal_Chisqt_Total"<<std::endl;
...
stream << std::fixed << std::setprecision(1) << ZShifts[least_Zafter].mean;
 mean_string = stream.str();
stream.str(std::string());
stream << std::fixed << std::setprecision(1) << ZShifts[least_Zafter].stddev;
 stddev_string = stream.str();
 stream.str(std::string());
 stream << std::fixed << std::setprecision(1) << LeastChisqt_Z_after;
 chisqrt_string = stream.str();
 stream.str(std::string());
 PlotTitle = " Min(#sigma,#mu) = (" + stddev_string +  ", " + mean_string +" ) =[Log #chi_{Z}^{2}] = " + chisqrt_string;
Convolution_Tool_TotalPlaylist.Plot_AfterFit_material_Full(PlotTitle);
wgt_vector.clear();
wgt_error_vector.clear();
Convolution_Tool_TotalPlaylist.Clear_Al_wgt();
...
////////////////////////////////////////////////////////////
Convolution_Tool_TotalPlaylist.initFULLONLY_RECO_Convolution_Material_Regions_Hists_PlaylistCombinedMC(least_Combinedafter.i,least_Combinedafter.j, least_Combinedafter.k);
//std::cout<<"Cal_Chisqt_Total"<<std::endl;
...
stream << std::fixed << std::setprecision(1) << ZShifts[least_Combinedafter].mean;
 mean_string = stream.str();
stream.str(std::string());
stream << std::fixed << std::setprecision(1) << ZShifts[least_Combinedafter].stddev;
 stddev_string = stream.str();
 stream.str(std::string());
 stream << std::fixed << std::setprecision(1) << LeastChisqt_Combined_after;
 chisqrt_string = stream.str();
 PlotTitle = " Min(#sigma,#mu) = (" + stddev_string +  ", " + mean_string + " )  [Log #chi_{X+Y+Z}^{2}] = " + chisqrt_string;
Convolution_Tool_TotalPlaylist.Plot_AfterFit_material_Full(PlotTitle);
wgt_vector.clear();
wgt_error_vector.clear();
Convolution_Tool_TotalPlaylist.Clear_Al_wgt();
