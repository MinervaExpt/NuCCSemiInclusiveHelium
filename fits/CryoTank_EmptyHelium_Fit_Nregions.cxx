...
sprintf(text_title_pdf1, "Plots_CryoVertex_Fitting_N_Regions_Convolution.pdf(" );
can -> Print(text_title_pdf1);
sprintf(text_title_pdf2, "Plots_CryoVertex_Fitting_N_Regions_Convolution.pdf" );
sprintf(text_title_pdf2, "Plots_CryoVertex_Fitting_N_Regions_Convolution.pdf" );
sprintf(text_title_pdf3, "Plots_CryoVertex_Fitting_N_Regions_Convolution.pdf)" );
sprintf(text_title_pdf4, "Plots_CryoVertex_Fitting_N_Regions_Convolution" );
std::string PDF_label(text_title_pdf4);

sprintf(text_title_noshift_pdf1, "Plots_CryoVertex_AllNuME_NOshifted_NoFid.pdf(" );
can -> Print(text_title_noshift_pdf1);
sprintf(text_title_noshift_pdf3, "Plots_CryoVertex_AllNuME_NOshifted_NoFid.pdf)" );


std::string PDF_label_noshift = "Plots_CryoVertex_AllNuME_NOshifted_NoFid";
...
auto PlaylistME_noshift_1G_MC_path = "/minerva/data/users/cnguyen/ME_MC_EventSection_RootFiles/Histograms_minervame1G_MC_StatsONLYErrors_ThreeRegion_sideBandShift_Noshift_noWgts_NoFid_ShiftAll.root";
auto PlaylistME_noshift_1A_MC_path = "/minerva/data/users/cnguyen/ME_MC_EventSection_RootFiles/Histograms_minervame1A_MC_StatsONLYErrors_ThreeRegion_sideBandShift_Noshift_noWgts_NoFid_ShiftAll.root";
auto PlaylistME_noshift_1L_MC_path = "/minerva/data/users/cnguyen/ME_MC_EventSection_RootFiles/Histograms_minervame1L_MC_StatsONLYErrors_ThreeRegion_sideBandShift_Noshift_noWgts_NoFid_ShiftAll.root";
auto PlaylistME_noshift_1M_MC_path = "/minerva/data/users/cnguyen/ME_MC_EventSection_RootFiles/Histograms_minervame1M_MC_StatsONLYErrors_ThreeRegion_sideBandShift_Noshift_noWgts_NoFid_ShiftAll.root";
auto PlaylistME_noshift_1N_MC_path = "/minerva/data/users/cnguyen/ME_MC_EventSection_RootFiles/Histograms_minervame1N_MC_StatsONLYErrors_ThreeRegion_sideBandShift_Noshift_noWgts_NoFid_ShiftAll.root";
...
auto PlaylistME_noshift_1P_MC_path = "/minerva/data/users/cnguyen/ME_MC_EventSection_RootFiles/Histograms_minervame1P_MC_StatsONLYErrors_ThreeRegion_sideBandShift_Noshift_noWgts_NoFid_ShiftAll.root";
auto PlaylistME_noshift_1C_MC_path = "/minerva/data/users/cnguyen/ME_MC_EventSection_RootFiles/Histograms_minervame1C_MC_StatsONLYErrors_ThreeRegion_sideBandShift_Noshift_noWgts_NoFid_ShiftAll.root";
auto PlaylistME_noshift_1D_MC_path = "/minerva/data/users/cnguyen/ME_MC_EventSection_RootFiles/Histograms_minervame1D_MC_StatsONLYErrors_ThreeRegion_sideBandShift_Noshift_noWgts_NoFid_ShiftAll.root";
auto PlaylistME_noshift_1F_MC_path = "/minerva/data/users/cnguyen/ME_MC_EventSection_RootFiles/Histograms_minervame1F_MC_StatsONLYErrors_ThreeRegion_sideBandShift_Noshift_noWgts_NoFid_ShiftAll.root";
auto PlaylistME_noshift_1E_MC_path = "/minerva/data/users/cnguyen/ME_MC_EventSection_RootFiles/Histograms_minervame1E_MC_StatsONLYErrors_ThreeRegion_sideBandShift_Noshift_noWgts_NoFid_ShiftAll.root";
...
//const char* PlaylistME_1G_Data_path = "/minerva/data/users/cnguyen/ME_DATA_EventSection_RootFiles/Histograms_minervame1G_Data_SideBand_NoFid.root"; //(PlaylistME_1G_Data_path);
...
//const char* PlaylistME_1F_Data_path =  "/minerva/data/users/cnguyen/ME_DATA_EventSection_RootFiles/Histograms_minervame1F_Data_SideBand_NoFid.root"; //(PlaylistME_1F_Data_path);
...
Helium_3CryoRegionsSideBandTool HeliumSideBand_Tool(
FullTFile_Map_MC,
FullTFile_Map_Data,
EmptyTFile_Map_MC,
EmptyTFile_Map_Data,
...
HeliumSideBand_Tool.InputPDFLabel(PDF_label);
HeliumSideBand_Tool.init_playlists(fullPlayList_Vector, EmptyPlayList_Vector);
HeliumSideBand_Tool.initNRegionsNames_Empty();
HeliumSideBand_Tool.PrintNRegionsNames_Empty();
std::cout<<"Started: initSideBands_CombinedEmptyDataplaylist_Combinedonly"<< std::endl;
HeliumSideBand_Tool.initSideBands_CombinedEmptyDataplaylist_Combinedonly();
std::cout<<"Finshed: initSideBands_CombinedEmptyDataplaylist_Combinedonly"<< std::endl;

HeliumSideBand_Tool.init_Region_Map_MaterialHists_Empty();
HeliumSideBand_Tool.FillPOT_HeliumNSideBand_Map();
HeliumSideBand_Tool.Scale_intit_Empty_NSideBand_Map();
std::cout<<"Starting to Plot:Plot_init_FitVar_Region14_Empty "<<std::endl;
HeliumSideBand_Tool.Plot_init_FitVar_Region14_Empty();
std::cout<<"Finished: init_Region_Map_MaterialHists_Empty"<< std::endl;

SetHelium3SideBandTool(HeliumSideBand_Tool);
std::vector<double> wgt_vector;
std::vector<double> wgt_error_vector;
FitSideBands(HeliumSideBand_Tool, 10,
  "fourbandFit","fourbandFit", PDF_label,  wgt_vector, wgt_error_vector, errorfit);

HeliumSideBand_Tool.Fill_Alwgt(wgt_vector, wgt_error_vector );
HeliumSideBand_Tool.ApplyFitResultsNSideBand_Empty();
HeliumSideBand_Tool.Plot_after_FitVar_Region14_Empty();
...
//Helium3SideBand_Tool_FullPlaylist.Plot_initHist("All","All", "[Convolution applied + Empty ^{27}Al Wgts][Fid]");
//Helium3SideBand_Tool_FullPlaylist.Plot_initResolutionHist("[Convolution applied][Fid]", "All","All");
