...
#include "NonMuonKinematic2DPlots.h"
//////////////////////////////////////////////////////////////////////////////
...
sprintf(text_title_pdf1, "PLOTS_%s_Non_muonTrk_secondaryTrk_CV_ErrorBand_LE.pdf(",timeset_nonstacks );
can -> Print(text_title_pdf1);
sprintf(text_title_pdf2, "PLOTS_%s_Non_muonTrk_secondaryTrk_CV_ErrorBand_LE.pdf",timeset_nonstacks );
sprintf(text_title_pdf2, "PLOTS_%s_Non_muonTrk_secondaryTrk_CV_ErrorBand_LE.pdf",timeset_nonstacks );
sprintf(text_title_pdf3, "PLOTS_%s_Non_muonTrk_secondaryTrk_CV_ErrorBand_LE.pdf)",timeset_nonstacks );
sprintf(text_title_pdf4, "PLOTS_%s_Non_muonTrk_secondaryTrk_CV_ErrorBand_LE",timeset_nonstacks );
