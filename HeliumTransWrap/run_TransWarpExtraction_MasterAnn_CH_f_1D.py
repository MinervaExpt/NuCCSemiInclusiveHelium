...
#variables = ["Q2", "pt", "pll"]
variables = ["MuonPZ_Closure", "MuonTheta_Closure", "MuonPT_Closure", "MuonE_Closure"]
#
...
for var in variables:
    ...
    for f in  [1, 2, 3, 5, 5.1449, 8, 15]:
#1, 2, 3, 5, 8, 9.5813, 10,
        output_file_name =  var + "_f_"+str(f)+ ".root"
        ...
        cmd_base = "./TransWarpExtraction" \
            ...
            + " --num_iter        1,2,3,4,5,6,7,8,10,15,20" \
            + " --num_uni         1000" \
            + " --max_chi2        20" \
            + " --step_chi2       0.5" \
            + " --num_dim         1" \
