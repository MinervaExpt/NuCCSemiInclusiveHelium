...
for var in variables:
    ...
    for F in [8, 7.5, 7, 6.5 ,6]:
        ...
        input_file_name =   inputdir + var + "_f_" + str(9.5813) + "NEW1.root "

        cmd = "python ProcessMCSampleSizeScan.py" \
              + " --n_uni                     1000" \
              + " --iters                     1,2,3,4,5,6,7,10" \
